import { Fiber } from "./types-D7j5ftmS.js";
...
declare const getCurrentDispatcher: () => null | React$1.RefObject<unknown>;
declare const setCurrentDispatcher: (value: null | React$1.RefObject<unknown>) => void;
declare const formatOwnerStack: (error: Error) => string;
declare const getFiberStackFrame: (fiber: Fiber) => null | string;
