 ...
 */
import { B as ARROW_MAX_LABEL_WIDTH_RATIO, G as DROPDOWN_OFFSCREEN_POSITION, H as DRAG_LERP_FACTOR, J as HINT_FLIP_IN_ANIMATION, K as FEEDBACK_DURATION_MS, N as nativeCancelAnimationFrame, P as nativeRequestAnimationFrame, V as DEFAULT_ACTION_ID, W as DROPDOWN_EDGE_TRANSFORM_ORIGIN, Y as LERP_CONVERGENCE_THRESHOLD_PX, _t as Z_INDEX_OVERLAY_CANVAS, a as freezeGlobalAnimations, at as OVERLAY_FILL_COLOR_DEFAULT, ct as SELECTION_HINT_CYCLE_INTERVAL_MS, d as freezePseudoStates, dt as TOOLBAR_DEFAULT_POSITION_RATIO, ft as TOOLBAR_SHAKE_TOOLTIP_DURATION_MS, gt as Z_INDEX_OVERLAY, it as OVERLAY_BORDER_COLOR_DRAG, lt as SELECTION_LABEL_OFFSCREEN_PX, m as unfreezePseudoStates, nt as OPACITY_CONVERGENCE_THRESHOLD, o as unfreezeGlobalAnimations, ot as OVERLAY_FILL_COLOR_DRAG, pt as TOOLTIP_BASE_CLASS, q as FROZEN_GLOW_COLOR, rt as OVERLAY_BORDER_COLOR_DEFAULT, s as openFile, t as freezeUpdates, ut as SELECTION_LERP_FACTOR, vt as supportsDisplayP3 } from "./freeze-updates-_oPTEaF7.js";
import { a as isMac, c as getCollapsedPosition, d as getSnapPosition, f as getVisualViewport, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, l as getPositionFromEdgeAndRatio, n as saveToolbarState, o as calculateExpandedPositionFromCollapsed, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState, u as getRatioFromPosition } from "./state-B5k7Vo_r.js";
	...
	return (() => {
		...
		insert(_el$3, createComponent(For, {
			...
			children: (commit) => {
				...
				return (() => {
					var _el$8 = _tmpl$2$7();
					effect((_$p) => setStyleProperty(_el$8, "height", `${barHeight()}px`));
					return _el$8;
				})();
			}
		}));
		insert(_el$4, () => props.timeline.totalRenderCount, _el$5);
		insert(_el$4, () => props.timeline.totalRenderCount !== 1 ? "s" : "", _el$7);
		insert(_el$4, () => formatDuration(totalDuration()), null);
		return _el$;
	})();
};
...
const ElementPropertiesPanel = (props) => createComponent(BottomSection, { get children() {
	var _el$5 = _tmpl$6$2();
	_el$5.$$pointerdown = (event) => event.stopPropagation();
	insert(_el$5, createComponent(PropertyRow, {
		label: "Size",
		get value() {
	...
	insert(_el$5, createComponent(For, {
		...
		children: (row) => createComponent(PropertyRow, {
			get label() {
				return row.label;
			},
			get value() {
	...
	insert(_el$5, createComponent(Show, {
		...
		get children() {
			return [
				createComponent(SectionDivider, {}),
				createComponent(Show, {
					...
					get children() {
						var _el$6 = _tmpl$3$5();
						insert(_el$6, () => props.state.renderedBy);
						return _el$6;
					}
				}),
				createComponent(Show, {
					...
					get children() {
						var _el$7 = _tmpl$4$4();
						insert(_el$7, () => props.state.source);
						return _el$7;
					}
				})
			];
	...
	insert(_el$5, createComponent(Show, {
		...
		get children() {
			return [createComponent(SectionDivider, {}), (() => {
				var _el$8 = _tmpl$5$3();
				insert(_el$8, () => props.state.className);
				return _el$8;
			})()];
		}
	}), null);
	insert(_el$5, createComponent(Show, {
		get when() {
			return memo(() => !!props.state.timeline)() && props.state.timeline.totalRenderCount > 0;
		},
		get children() {
			return [createComponent(SectionDivider, {}), createComponent(RenderTimelineBar, { get timeline() {
