 ...
 */
const require_freeze_updates = require('./freeze-updates-BXMr6a9g.cjs');
const require_state = require('./state-D5n1XOr-.cjs');
...
var _tmpl$$29 = /* @__PURE__ */ (0, solid_js_web.template)(`<canvas data-react-grab-overlay-canvas style=position:fixed;top:0;left:0;pointer-events:none>`);
...
var _tmpl$$28 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 12 12"fill=none><path d="M6 1L6 11M6 1L2 5M6 1L10 5"stroke=currentColor stroke-width=1.5 stroke-linecap=round stroke-linejoin=round>`);
...
var _tmpl$$26 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-arrow class="absolute w-0 h-0 z-10">`);
const Arrow = (props) => {
...
var _tmpl$$25 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-linecap=round stroke-linejoin=round stroke-width=2><path d="M12 6H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6"></path><path d="M11 13l9-9"></path><path d="M15 4h5v5">`);
...
var _tmpl$$24 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class=text-black>`), _tmpl$2$10 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class=text-black/50>.`), _tmpl$3$7 = /* @__PURE__ */ (0, solid_js_web.template)(`<div><span class="text-[13px] leading-4 h-fit font-medium overflow-hidden text-ellipsis whitespace-nowrap min-w-0">`);
...
var _tmpl$$23 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="[font-synthesis:none] contain-layout shrink-0 flex flex-col items-start px-2 py-1.5 w-auto h-fit self-stretch [border-top-width:0.5px] border-t-solid border-t-[#D9D9D9] antialiased rounded-t-none rounded-b-[6px]">`);
...
var _tmpl$$20 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4C7.58 4 4.01 7.58 4.01 12C4.01 16.42 7.58 20 12 20C15.73 20 18.84 17.45 19.73 14H17.65C16.83 16.33 14.61 18 12 18C8.69 18 6 15.31 6 12C6 8.69 8.69 6 12 6C13.66 6 15.14 6.69 16.22 7.78L13 11H20V4L17.65 6.35Z"fill=currentColor>`);
...
var _tmpl$$18 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=currentColor><circle cx=5 cy=12 r=2></circle><circle cx=12 cy=12 r=2></circle><circle cx=19 cy=12 r=2>`);
		...
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.For, {
			...
			children: (item, itemIndex) => (() => {
				...
				(0, solid_js_web.insert)(_el$4, (0, solid_js_web.createComponent)(solid_js.Show, {
					...
					get children() {
						return [(0, solid_js_web.memo)(() => item.componentName), _tmpl$2$6()];
					}
				}), null);
		...
		get children() {
			...
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
				...
				get children() {
					...
					(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(solid_js.Show, {
						get when() {
							return (0, solid_js_web.memo)(() => !!(!isArrowNavigationVisible() && isInspectNavigationVisible()))() && props.inspectNavigationState;
						},
						children: (state) => (0, solid_js_web.createComponent)(ArrowNavigationMenu, {
							get items() {
								return state().items;
							},
							get activeIndex() {
...
const Tooltip = (props) => {
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			...
			(0, solid_js_web.setStyleProperty)(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			(0, solid_js_web.insert)(_el$, () => props.children);
			(0, solid_js_web.effect)(() => (0, solid_js_web.className)(_el$, cn(require_freeze_updates.TOOLTIP_BASE_CLASS, "bg-white", props.position === "left" || props.position === "right" ? "top-1/2 -translate-y-1/2" : "left-1/2 -translate-x-1/2", props.position === "top" && "bottom-full mb-2.5", props.position === "bottom" && "top-full mt-2.5", props.position === "left" && "right-full mr-2.5", props.position === "right" && "left-full ml-2.5", shouldAnimate() && "animate-tooltip-fade-in")));
			return _el$;
		}
	});
};
...
const Toolbar = (props) => {
	...
	return (() => {
		...
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(ToolbarContent, {
			...
			get toggleButton() {
				return [(() => {
					...
					(0, solid_js_web.effect)((_p$) => {
						var _v$0 = props.enabled ? "Disable React Grab" : "Enable React Grab", _v$1 = Boolean(props.enabled), _v$10 = cn("contain-layout flex items-center justify-center cursor-pointer interactive-scale outline-none", isVertical() ? "my-0.5" : "mx-0.5"), _v$11 = cn("relative rounded-full transition-colors", isVertical() ? "w-3.5 h-2.5" : "w-5 h-3", props.enabled ? "bg-black" : "bg-black/25"), _v$12 = cn("absolute top-0.5 rounded-full bg-white transition-transform", isVertical() ? "w-1.5 h-1.5" : "w-2 h-2", !props.enabled && "left-0.5", props.enabled && (isVertical() ? "left-1.5" : "left-2.5"));
						_v$0 !== _p$.e && (0, solid_js_web.setAttribute)(_el$15, "aria-label", _p$.e = _v$0);
						_v$1 !== _p$.t && (0, solid_js_web.setAttribute)(_el$15, "aria-pressed", _p$.t = _v$1);
						_v$10 !== _p$.a && (0, solid_js_web.className)(_el$15, _p$.a = _v$10);
						_v$11 !== _p$.o && (0, solid_js_web.className)(_el$16, _p$.o = _v$11);
						_v$12 !== _p$.i && (0, solid_js_web.className)(_el$17, _p$.i = _v$12);
						return _p$;
					}, {
						e: void 0,
						t: void 0,
			...
			get children() {
				return [(0, solid_js_web.createComponent)(solid_js.Show, {
					...
					get children() {
						var _el$1 = _tmpl$5$1();
						(0, solid_js_web.effect)((_p$) => {
							var _v$3 = cn(require_freeze_updates.TOOLTIP_BASE_CLASS, "animate-tooltip-fade-in", "bg-white", shakeTooltipPositionClass()), _v$4 = { [isVertical() ? "top" : "left"]: "50%" }, _v$5 = String(require_freeze_updates.Z_INDEX_OVERLAY);
							_v$3 !== _p$.e && (0, solid_js_web.className)(_el$1, _p$.e = _v$3);
							_p$.t = (0, solid_js_web.style)(_el$1, _v$4, _p$.t);
							_v$5 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$1, "z-index", _p$.a = _v$5);
							return _p$;
						}, {
							e: void 0,
							t: void 0,
		...
		(0, solid_js_web.effect)((_p$) => {
			var _v$6 = cn("fixed left-0 top-0 font-sans text-[13px] antialiased select-none", getCursorClass(), getTransitionClass(), isVisible() ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"), _v$7 = String(require_freeze_updates.Z_INDEX_OVERLAY), _v$8 = `translate(${currentPosition().x}px, ${currentPosition().y}px)`, _v$9 = getTransformOrigin();
			_v$6 !== _p$.e && (0, solid_js_web.className)(_el$, _p$.e = _v$6);
			_v$7 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "z-index", _p$.t = _v$7);
			_v$8 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$, "transform", _p$.a = _v$8);
			_v$9 !== _p$.o && (0, solid_js_web.setStyleProperty)(_el$, "transform-origin", _p$.o = _v$9);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
