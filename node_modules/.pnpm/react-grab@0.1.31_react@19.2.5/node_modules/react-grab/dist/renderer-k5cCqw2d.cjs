...
const RenderTimelineBar = (props) => {
	...
	return (() => {
		...
		_el$7.nextSibling;
		(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.For, {
			get each() {
			...
			children: (commit) => {
				...
				return (() => {
					var _el$8 = _tmpl$2$7();
					(0, solid_js_web.effect)((_p$) => {
						var _v$ = `${barHeight()}px`, _v$2 = getBarColor(commit.duration);
						_v$ !== _p$.e && (0, solid_js_web.setStyleProperty)(_el$8, "height", _p$.e = _v$);
						_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$8, "background-color", _p$.t = _v$2);
						return _p$;
					}, {
						e: void 0,
						t: void 0
		...
		(0, solid_js_web.insert)(_el$3, () => props.timeline.totalRenderCount, _el$4);
		(0, solid_js_web.insert)(_el$3, () => props.timeline.totalRenderCount !== 1 ? "s" : "", _el$7);
		(0, solid_js_web.insert)(_el$3, () => formatDuration(totalDuration()), null);
		return _el$;
	})();
};
...
const ElementPropertiesPanel = (props) => (0, solid_js_web.createComponent)(BottomSection, { get children() {
	...
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			var _el$6 = _tmpl$3$5();
			(0, solid_js_web.insert)(_el$6, () => props.state.source);
			return _el$6;
		}
	}), null);
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			return (0, solid_js_web.createComponent)(RenderTimelineBar, { get timeline() {
	...
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		get when() {
			return props.state.source || props.state.timeline && props.state.timeline.totalRenderCount > 0;
		},
		get children() {
	...
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			return [(0, solid_js_web.createComponent)(SectionDivider, {}), (() => {
				var _el$7 = _tmpl$4$4();
				(0, solid_js_web.insert)(_el$7, () => props.state.className);
				return _el$7;
			})()];
		}
	}), null);
