...
var _tmpl$$30 = /* @__PURE__ */ (0, solid_js_web.template)(`<canvas data-react-grab-overlay-canvas style=position:fixed;top:0;left:0;pointer-events:none>`);
...
var _tmpl$$29 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 12 12"fill=none><path d="M6 1L6 11M6 1L2 5M6 1L10 5"stroke=currentColor stroke-width=1.5 stroke-linecap=round stroke-linejoin=round>`);
...
var _tmpl$$27 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-arrow class="absolute w-0 h-0 z-10">`);
const Arrow = (props) => {
...
var _tmpl$$26 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-linecap=round stroke-linejoin=round stroke-width=2><path d="M12 6H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6"></path><path d="M11 13l9-9"></path><path d="M15 4h5v5">`);
...
var _tmpl$$25 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class=text-black>`), _tmpl$2$11 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class=text-black/50>.`), _tmpl$3$8 = /* @__PURE__ */ (0, solid_js_web.template)(`<div><span class="text-[13px] leading-4 h-fit font-medium overflow-hidden text-ellipsis whitespace-nowrap min-w-0">`);
...
var _tmpl$$24 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="[font-synthesis:none] contain-layout shrink-0 flex flex-col items-start px-2 py-1.5 w-auto h-fit self-stretch [border-top-width:0.5px] border-t-solid border-t-[#D9D9D9] antialiased rounded-t-none rounded-b-[6px]">`);
...
const DiscardPrompt = (props) => {
	...
	return (() => {
		var _el$ = _tmpl$2$10(), _el$3 = _el$.firstChild.firstChild;
...
var _tmpl$$21 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4C7.58 4 4.01 7.58 4.01 12C4.01 16.42 7.58 20 12 20C15.73 20 18.84 17.45 19.73 14H17.65C16.83 16.33 14.61 18 12 18C8.69 18 6 15.31 6 12C6 8.69 8.69 6 12 6C13.66 6 15.14 6.69 16.22 7.78L13 11H20V4L17.65 6.35Z"fill=currentColor>`);
		...
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.Show, {
			...
			get children() {
				return (0, solid_js_web.createComponent)(BottomSection, { get children() {
					var _el$4 = _tmpl$$20(), _el$5 = _el$4.firstChild;
					_el$5.firstChild;
...
var _tmpl$$19 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=currentColor><circle cx=5 cy=12 r=2></circle><circle cx=12 cy=12 r=2></circle><circle cx=19 cy=12 r=2>`);
		...
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.For, {
			...
			children: (item, itemIndex) => (() => {
				...
				(0, solid_js_web.insert)(_el$4, (0, solid_js_web.createComponent)(solid_js.Show, {
					...
					get children() {
						return [(0, solid_js_web.memo)(() => item.componentName), _tmpl$2$7()];
					}
				}), null);
