...
const Toolbar = (props) => {
	...
	return (() => {
			...
			get toggleButton() {
				return [(() => {
					...
					effect((_p$) => {
						...
						_v$0 !== _p$.e && setAttribute(_el$15, "aria-label", _p$.e = _v$0);
						_v$1 !== _p$.t && setAttribute(_el$15, "aria-pressed", _p$.t = _v$1);
						_v$10 !== _p$.a && className(_el$15, _p$.a = _v$10);
						_v$11 !== _p$.o && className(_el$16, _p$.o = _v$11);
						_v$12 !== _p$.i && className(_el$17, _p$.i = _v$12);
						return _p$;
					}, {
						e: void 0,
						t: void 0,
			...
			get children() {
				return [createComponent(Show, {
					...
					get children() {
						var _el$1 = _tmpl$5$1();
						effect((_p$) => {
							var _v$3 = cn(TOOLTIP_BASE_CLASS, "animate-tooltip-fade-in", "bg-white", shakeTooltipPositionClass()), _v$4 = { [isVertical() ? "top" : "left"]: "50%" }, _v$5 = String(Z_INDEX_OVERLAY);
							_v$3 !== _p$.e && className(_el$1, _p$.e = _v$3);
							_p$.t = style(_el$1, _v$4, _p$.t);
							_v$5 !== _p$.a && setStyleProperty(_el$1, "z-index", _p$.a = _v$5);
							return _p$;
						}, {
							e: void 0,
							t: void 0,
		...
		effect((_p$) => {
			var _v$6 = cn("fixed left-0 top-0 font-sans text-[13px] antialiased select-none", getCursorClass(), getTransitionClass(), isVisible() ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"), _v$7 = String(Z_INDEX_OVERLAY), _v$8 = `translate(${currentPosition().x}px, ${currentPosition().y}px)`, _v$9 = getTransformOrigin();
			_v$6 !== _p$.e && className(_el$, _p$.e = _v$6);
			_v$7 !== _p$.t && setStyleProperty(_el$, "z-index", _p$.t = _v$7);
			_v$8 !== _p$.a && setStyleProperty(_el$, "transform", _p$.a = _v$8);
			_v$9 !== _p$.o && setStyleProperty(_el$, "transform-origin", _p$.o = _v$9);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
