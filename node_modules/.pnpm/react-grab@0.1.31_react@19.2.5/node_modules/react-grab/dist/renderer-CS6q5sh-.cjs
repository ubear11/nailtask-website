 ...
 */
const require_state = require('./state-arg5pYvx.cjs');
const require_freeze_updates = require('./freeze-updates-Db4Id665.cjs');
	...
	return (() => {
			...
			get toggleButton() {
				return [(() => {
					...
					require_state.createRenderEffect((_p$) => {
						...
						_v$1 !== _p$.e && require_state.setAttribute(_el$15, "aria-label", _p$.e = _v$1);
						_v$10 !== _p$.t && require_state.setAttribute(_el$15, "aria-pressed", _p$.t = _v$10);
						_v$11 !== _p$.a && require_state.className(_el$15, _p$.a = _v$11);
						_v$12 !== _p$.o && require_state.className(_el$16, _p$.o = _v$12);
						_v$13 !== _p$.i && require_state.className(_el$17, _p$.i = _v$13);
						return _p$;
					}, {
						e: void 0,
						t: void 0,
		...
		require_state.insert(_el$, require_state.createComponent(require_state.Show, {
			...
			get children() {
				...
				require_state.createRenderEffect((_p$) => {
					var _v$ = cn(require_freeze_updates.TOOLTIP_BASE_CLASS, "flex items-center gap-1 animate-tooltip-fade-in [animation-fill-mode:backwards]", "bg-white", shakeTooltipPositionClass()), _v$2 = { [isVertical() ? "top" : "left"]: "50%" }, _v$3 = String(require_freeze_updates.Z_INDEX_OVERLAY);
					_v$ !== _p$.e && require_state.className(_el$2, _p$.e = _v$);
					_p$.t = require_state.style(_el$2, _v$2, _p$.t);
					_v$3 !== _p$.a && require_state.setStyleProperty(_el$2, "z-index", _p$.a = _v$3);
					return _p$;
				}, {
					e: void 0,
					t: void 0,
		...
		require_state.insert(_el$, require_state.createComponent(require_state.Show, {
			...
			get children() {
				var _el$1 = _tmpl$5$1();
				require_state.createRenderEffect((_p$) => {
					var _v$4 = cn(require_freeze_updates.TOOLTIP_BASE_CLASS, "animate-tooltip-fade-in", "bg-white", shakeTooltipPositionClass()), _v$5 = { [isVertical() ? "top" : "left"]: "50%" }, _v$6 = String(require_freeze_updates.Z_INDEX_OVERLAY);
					_v$4 !== _p$.e && require_state.className(_el$1, _p$.e = _v$4);
					_p$.t = require_state.style(_el$1, _v$5, _p$.t);
					_v$6 !== _p$.a && require_state.setStyleProperty(_el$1, "z-index", _p$.a = _v$6);
					return _p$;
				}, {
					e: void 0,
					t: void 0,
		...
		require_state.createRenderEffect((_p$) => {
			var _v$7 = cn("fixed left-0 top-0 font-sans text-[13px] antialiased select-none", getCursorClass(), getTransitionClass(), isVisible() ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"), _v$8 = String(require_freeze_updates.Z_INDEX_OVERLAY), _v$9 = `translate(${currentPosition().x}px, ${currentPosition().y}px)`, _v$0 = getTransformOrigin();
			_v$7 !== _p$.e && require_state.className(_el$, _p$.e = _v$7);
			_v$8 !== _p$.t && require_state.setStyleProperty(_el$, "z-index", _p$.t = _v$8);
			_v$9 !== _p$.a && require_state.setStyleProperty(_el$, "transform", _p$.a = _v$9);
			_v$0 !== _p$.o && require_state.setStyleProperty(_el$, "transform-origin", _p$.o = _v$0);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
	...
	require_state.onMount(() => {
		...
		const handleKeyDown = (event) => {
			...
			const runActionIfAllowed = (action) => {
				...
				if (!require_state.resolveActionEnabled(action, context)) return false;
				event.preventDefault();
				event.stopPropagation();
