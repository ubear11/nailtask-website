	...
	return createComponent(Show, {
		...
		get children() {
			return createComponent(BottomSection, { get children() {
				...
				insert(_el$5, createComponent(Show, {
					get when() {
						return memo(() => !!hasTimeline())() && props.state.timeline;
					},
				...
				insert(_el$5, createComponent(Show, {
					get when() {
						return memo(() => !!hasTopSection())() && (hasProps() || hasHooks());
					},
					get children() {
