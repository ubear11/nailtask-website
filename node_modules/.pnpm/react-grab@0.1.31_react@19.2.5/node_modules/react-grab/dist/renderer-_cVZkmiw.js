...
const ElementPropertiesPanel = (props) => createComponent(BottomSection, { get children() {
	...
	insert(_el$5, createComponent(Show, {
		get when() {
			return memo(() => !!(props.state.source || props.state.timeline && props.state.timeline.totalRenderCount > 0))() && (props.state.reactProps.length > 0 || props.state.hooks.length > 0);
		},
		get children() {
