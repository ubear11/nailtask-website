 ...
 */
import { $ as MAX_SESSION_STORAGE_SIZE_BYTES, A as Se, B as getTagName, D as kt, E as Mt, F as nativeCancelAnimationFrame, G as DRAG_SELECTION_COVERAGE_THRESHOLD, I as nativeRequestAnimationFrame, J as FEEDBACK_DURATION_MS, L as waitUntilNextFrame, M as Z, N as ve, O as Me, P as we, R as hideFromThirdParties, S as getNearestComponentName, T as resolveSource, U as DEFAULT_ACTION_ID, V as ARROW_KEYS, _ as isRootElement, _t as VERSION, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, d as freezePseudoStates, et as MODIFIER_KEYS, f as resumePointerEventsFreeze, g as isValidGrabbableElement, h as clearVisibilityCache, i as freezeAnimations, k as Oe, l as getElementAtPosition, m as unfreezePseudoStates, mt as TOOLBAR_DEFAULT_POSITION_RATIO, n as logRecoverableError, nt as NEXTJS_REVALIDATION_DELAY_MS, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, r as freezeAllAnimations, rt as OFFSCREEN_POSITION, s as openFile, t as freezeUpdates, tt as MOUNT_ROOT_RECHECK_DELAY_MS, u as getElementsAtPoint, v as checkIsNextProject, vt as ZOOM_DETECTION_THRESHOLD, w as getStackContext, y as getComponentDisplayName, yt as Z_INDEX_OVERLAY, z as detectCspNonce } from "./freeze-updates-nEZFE0MZ.js";
import { a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-F6IFxv1x.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-BzSobFPG.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-DR8I5wu2.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
