 ...
 */
import { formatOwnerStack, getOwnerStack, hasDebugStack, isSourceFile, normalizeFileName, parseStack } from "bippy/source";
...
//#endregion
//#region ../../node_modules/.pnpm/bippy@0.5.32_@types+react@19.2.11_react@19.2.3/node_modules/bippy/dist/rdt-hook.js
/**
* @license bippy
*
...
* LICENSE file in the root directory of this source tree.
*/
const e = `0.5.32`, t = `bippy-${e}`, n = Object.defineProperty, r = Object.prototype.hasOwnProperty, i = () => {}, a = (e) => {
	try {
...
//#endregion
//#region ../../node_modules/.pnpm/bippy@0.5.32_@types+react@19.2.11_react@19.2.3/node_modules/bippy/dist/install-hook-only.js
/**
* @license bippy
*
* Copyright (c) Aiden Bai
...
//#endregion
//#region ../../node_modules/.pnpm/bippy@0.5.32_@types+react@19.2.11_react@19.2.3/node_modules/bippy/dist/core.js
/**
* @license bippy
*
* Copyright (c) Aiden Bai
...
* LICENSE file in the root directory of this source tree.
*/
const d = 0, ee = 1, te = 3, ne = 5, re = 6, ie = 7, ae = 9, oe = 11, f = 13, p = 14, m = 15, h = 16, g = 18, se = 19, ce = 22, le = 23, ue = 26, de = 27, fe = 28, pe = 30, _ = 60111, v = `Symbol(react.element)`, y = `Symbol(react.transitional.element)`, b = `Symbol(react.concurrent_mode)`, x = `Symbol(react.async_mode)`, S = 13366, me = (e) => typeof e == `object` && !!e && `$$typeof` in e && [v, y].includes(String(e.$$typeof)), he = (e) => typeof e == `object` && !!e && `tag` in e && `stateNode` in e && `return` in e && `child` in e && `sibling` in e && `flags` in e, C = (e) => {
	switch (e.tag) {
		case 5:
		case 26:
		case 27: return !0;
...
}, _e = (e) => !e || typeof e != `object` ? !1 : `pendingProps` in e && !(`containerInfo` in e), ve = (e, t) => e === t || e.alternate === t || t.alternate === e, ye = (e, t) => {
	try {
...
}, T = (e) => !!(e.flags & (S | 8) || e.subtreeFlags & (S | 8)), E = (e) => {
	let t = [], n = [e];
	for (; n.length;) {
		let e = n.pop();
		e && (C(e) && T(e) && w(e) && t.push(e), e.child && n.push(e.child), e.sibling && n.push(e.sibling));
	}
	return t;
}, D = (e) => {
	let t = [], n = e;
	...
	let t = [], n = [];
	for (C(e) ? t.push(e) : e.child && n.push(e.child); n.length;) {
		let e = n.pop();
		if (!e) break;
		C(e) ? t.push(e) : e.child && n.push(e.child), e.sibling && n.push(e.sibling);
	}
	return t;
};
function j(e, t, n = !1) {
...
//#endregion
//#region ../../node_modules/.pnpm/bippy@0.5.32_@types+react@19.2.11_react@19.2.3/node_modules/bippy/dist/index.js
/**
* @license bippy
*
* Copyright (c) Aiden Bai
...
const traverseFibers = (fiber, onCompositeFiber) => {
	if (!fiber) return;
	if (ge(fiber)) onCompositeFiber(fiber);
...
//#endregion
export { OVERLAY_FILL_COLOR_DEFAULT as $, waitUntilNextFrame as A, FROZEN_GLOW_COLOR as B, getStack as C, Z as D, Te as E, DRAG_LERP_FACTOR as F, MODIFIER_KEYS as G, LERP_CONVERGENCE_THRESHOLD_PX as H, DRAG_SELECTION_COVERAGE_THRESHOLD as I, OFFSCREEN_POSITION as J, MOUNT_ROOT_RECHECK_DELAY_MS as K, DROPDOWN_EDGE_TRANSFORM_ORIGIN as L, ARROW_KEYS as M, ARROW_MAX_LABEL_WIDTH_RATIO as N, nativeCancelAnimationFrame as O, DEFAULT_ACTION_ID as P, OVERLAY_BORDER_COLOR_INSPECT as Q, DROPDOWN_OFFSCREEN_POSITION as R, getNearestComponentName as S, resolveSource as T, MAX_SELECTOR_COMBINATIONS as U, HINT_FLIP_IN_ANIMATION as V, MAX_SESSION_STORAGE_SIZE_BYTES as W, OVERLAY_BORDER_COLOR_DEFAULT as X, OPACITY_CONVERGENCE_THRESHOLD as Y, OVERLAY_BORDER_COLOR_DRAG as Z, isRootElement as _, freezeGlobalAnimations as a, SELECTION_LERP_FACTOR as at, getElementContext as b, clearElementPositionCache as c, TOOLTIP_BASE_CLASS as ct, freezePseudoStates as d, Z_INDEX_OVERLAY as dt, OVERLAY_FILL_COLOR_DRAG as et, resumePointerEventsFreeze as f, Z_INDEX_OVERLAY_CANVAS as ft, isValidGrabbableElement as g, clearVisibilityCache as h, freezeAnimations as i, SELECTION_LABEL_OFFSCREEN_PX as it, getTagName as j, nativeRequestAnimationFrame as k, getElementAtPosition as l, VERSION as lt, unfreezePseudoStates as m, logRecoverableError as n, RELEVANT_CSS_PROPERTIES as nt, unfreezeGlobalAnimations as o, TOOLBAR_DEFAULT_POSITION_RATIO as ot, suspendPointerEventsFreeze as p, supportsDisplayP3 as pt, NEXTJS_REVALIDATION_DELAY_MS as q, freezeAllAnimations as r, SELECTION_HINT_CYCLE_INTERVAL_MS as rt, openFile as s, TOOLBAR_SHAKE_TOOLTIP_DURATION_MS as st, freezeUpdates as t, OVERLAY_FILL_COLOR_INSPECT as tt, getElementsAtPoint as u, ZOOM_DETECTION_THRESHOLD as ut, checkIsNextProject as v, getStackContext as w, getHTMLPreview as x, getComponentDisplayName as y, FEEDBACK_DURATION_MS as z };