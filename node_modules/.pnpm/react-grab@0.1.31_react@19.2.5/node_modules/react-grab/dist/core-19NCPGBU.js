 ...
 */
import { $ as OFFSCREEN_POSITION, A as d, D as Z, F as detectCspNonce, I as getTagName, L as ARROW_KEYS, M as nativeRequestAnimationFrame, N as waitUntilNextFrame, O as ve, P as hideFromThirdParties, Q as NEXTJS_REVALIDATION_DELAY_MS, S as getNearestComponentName, T as resolveSource, V as DRAG_SELECTION_COVERAGE_THRESHOLD, W as FEEDBACK_DURATION_MS, X as MODIFIER_KEYS, Y as MAX_SESSION_STORAGE_SIZE_BYTES, Z as MOUNT_ROOT_RECHECK_DELAY_MS, _ as isRootElement, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, d as freezePseudoStates, f as resumePointerEventsFreeze, ft as VERSION, g as isValidGrabbableElement, h as clearVisibilityCache, i as freezeAnimations, j as nativeCancelAnimationFrame, k as we, l as getElementAtPosition, lt as TOOLBAR_DEFAULT_POSITION_RATIO, m as unfreezePseudoStates, mt as Z_INDEX_OVERLAY, n as logRecoverableError, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, pt as ZOOM_DETECTION_THRESHOLD, r as freezeAllAnimations, s as openFile, t as freezeUpdates, u as getElementsAtPoint, v as checkIsNextProject, w as getStackContext, y as getComponentDisplayName, z as DEFAULT_ACTION_ID } from "./freeze-updates-Dj77KOnQ.js";
import { a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-BBE_PH6r.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-Ce3YKJeo.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-DeJeXFJp.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
