 ...
 */
import { $ as MOUNT_ROOT_RECHECK_DELAY_MS, A as Z, D as Oe, E as Me, F as waitUntilNextFrame, I as hideFromThirdParties, K as FEEDBACK_DURATION_MS, L as detectCspNonce, M as we, N as nativeCancelAnimationFrame, O as Se, P as nativeRequestAnimationFrame, Q as MODIFIER_KEYS, R as getTagName, S as getNearestComponentName, T as resolveSource, U as DRAG_SELECTION_COVERAGE_THRESHOLD, V as DEFAULT_ACTION_ID, Z as MAX_SESSION_STORAGE_SIZE_BYTES, _ as isRootElement, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, d as freezePseudoStates, dt as TOOLBAR_DEFAULT_POSITION_RATIO, et as NEXTJS_REVALIDATION_DELAY_MS, f as resumePointerEventsFreeze, g as isValidGrabbableElement, gt as Z_INDEX_OVERLAY, h as clearVisibilityCache, ht as ZOOM_DETECTION_THRESHOLD, i as freezeAnimations, j as ve, l as getElementAtPosition, m as unfreezePseudoStates, mt as VERSION, n as logRecoverableError, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, r as freezeAllAnimations, s as openFile, t as freezeUpdates, tt as OFFSCREEN_POSITION, u as getElementsAtPoint, v as checkIsNextProject, w as getStackContext, y as getComponentDisplayName, z as ARROW_KEYS } from "./freeze-updates-_oPTEaF7.js";
import { a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-B5k7Vo_r.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-B30-9jNl.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-BZzJ1CQI.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
