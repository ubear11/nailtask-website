...
const RenderTimelineBar = (props) => {
	...
	return (() => {
		var _el$ = _tmpl$$16(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$2.nextSibling, _el$5 = _el$4.firstChild, _el$8 = _el$5.nextSibling;
		_el$8.nextSibling;
		(0, solid_js_web.insert)(_el$3, (0, solid_js_web.createComponent)(solid_js.For, {
			...
			children: (commit) => {
				...
				return (() => {
					var _el$9 = _tmpl$2$7();
					(0, solid_js_web.effect)((_$p) => (0, solid_js_web.setStyleProperty)(_el$9, "height", `${barHeight()}px`));
					return _el$9;
				})();
			}
		}));
		(0, solid_js_web.insert)(_el$4, () => props.timeline.totalRenderCount, _el$5);
		(0, solid_js_web.insert)(_el$4, () => props.timeline.totalRenderCount !== 1 ? "s" : "", _el$8);
