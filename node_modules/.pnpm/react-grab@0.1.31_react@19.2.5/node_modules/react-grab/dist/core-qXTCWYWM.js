 ...
 */
import { A as nativeRequestAnimationFrame, F as ARROW_KEYS, H as FEEDBACK_DURATION_MS, J as MODIFIER_KEYS, L as DEFAULT_ACTION_ID, M as hideFromThirdParties, N as detectCspNonce, P as getTagName, S as getNearestComponentName, T as resolveSource, X as NEXTJS_REVALIDATION_DELAY_MS, Y as MOUNT_ROOT_RECHECK_DELAY_MS, Z as OFFSCREEN_POSITION, _ as isRootElement, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, d as freezePseudoStates, f as resumePointerEventsFreeze, ft as VERSION, g as isValidGrabbableElement, h as clearVisibilityCache, i as freezeAnimations, j as waitUntilNextFrame, k as nativeCancelAnimationFrame, l as getElementAtPosition, lt as TOOLBAR_DEFAULT_POSITION_RATIO, m as unfreezePseudoStates, mt as Z_INDEX_OVERLAY, n as logRecoverableError, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, pt as ZOOM_DETECTION_THRESHOLD, q as MAX_SESSION_STORAGE_SIZE_BYTES, r as freezeAllAnimations, s as openFile, t as freezeUpdates, u as getElementsAtPoint, v as checkIsNextProject, w as getStackContext, y as getComponentDisplayName, z as DRAG_SELECTION_COVERAGE_THRESHOLD } from "./freeze-updates-D_pyTKMa.js";
import { a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-IvwJqLA-.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-BixKmj7b.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-DKW88_Tv.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
