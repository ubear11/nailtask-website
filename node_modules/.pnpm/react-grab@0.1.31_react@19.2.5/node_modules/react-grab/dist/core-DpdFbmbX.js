 ...
 */
import { $ as MOUNT_ROOT_RECHECK_DELAY_MS, A as Z, D as kt, E as Mt, F as waitUntilNextFrame, I as hideFromThirdParties, K as FEEDBACK_DURATION_MS, L as detectCspNonce, M as z, N as nativeCancelAnimationFrame, O as zt, P as nativeRequestAnimationFrame, Q as MODIFIER_KEYS, R as getTagName, S as getNearestComponentName, T as resolveSource, U as DRAG_SELECTION_COVERAGE_THRESHOLD, V as DEFAULT_ACTION_ID, Z as MAX_SESSION_STORAGE_SIZE_BYTES, _ as isRootElement, _t as Z_INDEX_OVERLAY, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, d as freezePseudoStates, et as NEXTJS_REVALIDATION_DELAY_MS, f as resumePointerEventsFreeze, ft as TOOLBAR_DEFAULT_POSITION_RATIO, g as isValidGrabbableElement, gt as ZOOM_DETECTION_THRESHOLD, h as clearVisibilityCache, ht as VERSION, i as freezeAnimations, j as ve, l as getElementAtPosition, m as unfreezePseudoStates, n as logRecoverableError, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, r as freezeAllAnimations, s as openFile, t as freezeUpdates, tt as OFFSCREEN_POSITION, u as getElementsAtPoint, v as checkIsNextProject, w as getStackContext, y as getComponentDisplayName, z as ARROW_KEYS } from "./freeze-updates-DPi1TPYT.js";
import { a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-C1Eby16Y.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-BRlxN2Fh.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-CpbW5TEt.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
