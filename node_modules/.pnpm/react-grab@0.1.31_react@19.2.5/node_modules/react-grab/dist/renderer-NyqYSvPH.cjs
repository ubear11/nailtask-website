 ...
 */
const require_freeze_updates = require('./freeze-updates-ChGGbLf0.cjs');
const require_state = require('./state-GAtI-kAH.cjs');
...
const RenderTimelineBar = (props) => {
	const maxDuration = () => Math.max(...props.timeline.commits.map((renderCommit) => renderCommit.duration), require_freeze_updates.RENDER_DURATION_NEGLIGIBLE_MS);
	...
	return (() => {
		...
		_el$7.nextSibling;
		(0, solid_js_web.setStyleProperty)(_el$2, "height", `${20}px`);
		(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.For, {
			...
			children: (renderCommit) => {
				...
				return (() => {
					var _el$8 = _tmpl$2$7();
					(0, solid_js_web.setStyleProperty)(_el$8, "width", `${2}px`);
					(0, solid_js_web.effect)((_p$) => {
...
const ElementPropertiesPanel = (props) => {
	const hasTimeline = () => Boolean(props.state.timeline && props.state.timeline.commits.length > 0);
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			return (0, solid_js_web.createComponent)(BottomSection, { get children() {
				...
				(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
						return (0, solid_js_web.memo)(() => !!hasTimeline())() && props.state.timeline;
					},
					children: (timeline) => (0, solid_js_web.createComponent)(RenderTimelineBar, { get timeline() {
						return timeline();
					} })
				}), null);
				(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
						return (0, solid_js_web.memo)(() => !!hasTopSection())() && (hasProps() || hasHooks());
					},
					get children() {
				...
				(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.For, {
					...
					children: (propertyRow) => (0, solid_js_web.createComponent)(PropertyRow, {
						get label() {
				...
				(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
					...
					get children() {
						return [(0, solid_js_web.createComponent)(SectionDivider, {}), (0, solid_js_web.createComponent)(solid_js.For, {
							...
							children: (hookRow) => (0, solid_js_web.createComponent)(PropertyRow, {
								get label() {
