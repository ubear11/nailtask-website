 ...
 */
const require_freeze_updates = require('./freeze-updates-Ce1c7pg9.cjs');
const require_state = require('./state-CvOoc-cE.cjs');
	...
	return (() => {
		...
		(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.For, {
			...
			children: (commit) => {
				...
				return (() => {
					var _el$5 = _tmpl$2$7();
					(0, solid_js_web.effect)((_$p) => (0, solid_js_web.setStyleProperty)(_el$5, "height", `${barHeight()}px`));
					return _el$5;
				})();
			}
		}));
		(0, solid_js_web.insert)(_el$3, () => props.timeline.totalRenderCount, _el$4);
		(0, solid_js_web.insert)(_el$3, () => props.timeline.totalRenderCount !== 1 ? "s" : "", null);
		return _el$;
	})();
};
