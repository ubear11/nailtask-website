 ...
 */
import { B as DRAG_LERP_FACTOR, G as FROZEN_GLOW_COLOR, H as DROPDOWN_EDGE_TRANSFORM_ORIGIN, K as HINT_FLIP_IN_ANIMATION, M as nativeRequestAnimationFrame, R as ARROW_MAX_LABEL_WIDTH_RATIO, U as DROPDOWN_OFFSCREEN_POSITION, W as FEEDBACK_DURATION_MS, a as freezeGlobalAnimations, ct as SELECTION_LERP_FACTOR, d as freezePseudoStates, dt as TOOLTIP_BASE_CLASS, et as OPACITY_CONVERGENCE_THRESHOLD, gt as supportsDisplayP3, ht as Z_INDEX_OVERLAY_CANVAS, it as OVERLAY_FILL_COLOR_DRAG, j as nativeCancelAnimationFrame, lt as TOOLBAR_DEFAULT_POSITION_RATIO, m as unfreezePseudoStates, mt as Z_INDEX_OVERLAY, nt as OVERLAY_BORDER_COLOR_DRAG, o as unfreezeGlobalAnimations, ot as SELECTION_HINT_CYCLE_INTERVAL_MS, q as LERP_CONVERGENCE_THRESHOLD_PX, rt as OVERLAY_FILL_COLOR_DEFAULT, s as openFile, st as SELECTION_LABEL_OFFSCREEN_PX, t as freezeUpdates, tt as OVERLAY_BORDER_COLOR_DEFAULT, ut as TOOLBAR_SHAKE_TOOLTIP_DURATION_MS, z as DEFAULT_ACTION_ID } from "./freeze-updates-Dj77KOnQ.js";
import { a as isMac, c as getCollapsedPosition, d as getSnapPosition, f as getVisualViewport, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, l as getPositionFromEdgeAndRatio, n as saveToolbarState, o as calculateExpandedPositionFromCollapsed, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState, u as getRatioFromPosition } from "./state-BBE_PH6r.js";
	...
	return (() => {
		...
		insert(_el$2, createComponent(For, {
			...
			children: (commit) => {
				...
				return (() => {
					var _el$5 = _tmpl$2$7();
					effect((_$p) => setStyleProperty(_el$5, "height", `${barHeight()}px`));
					return _el$5;
				})();
			}
		}));
		insert(_el$3, () => props.timeline.totalRenderCount, _el$4);
		insert(_el$3, () => props.timeline.totalRenderCount !== 1 ? "s" : "", null);
		return _el$;
	})();
};
