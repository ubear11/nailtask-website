 ...
 */
const require_state = require('./state-ClsRE3PT.cjs');
const require_freeze_updates = require('./freeze-updates-_q7KP1mg.cjs');
...
var _tmpl$$29 = /* @__PURE__ */ require_state.template(`<canvas data-react-grab-overlay-canvas style=position:fixed;top:0;left:0;pointer-events:none>`);
...
const LAYER_STYLES = {
	...
	inspect: {
		borderColor: require_freeze_updates.OVERLAY_BORDER_COLOR_INSPECT,
		fillColor: require_freeze_updates.OVERLAY_FILL_COLOR_INSPECT,
		lerpFactor: require_freeze_updates.SELECTION_LERP_FACTOR
	}
};
const OverlayCanvas = (props) => {
	...
	require_state.createEffect(require_state.on(() => [props.dragVisible, props.dragBounds], ([isVisible, bounds]) => {
		if (!isVisible || !bounds) {
			dragAnimation = null;
			scheduleAnimationFrame();
			return;
	...
	require_state.createEffect(require_state.on(() => [props.grabbedBoxes, props.labelInstances], ([grabbedBoxes, labelInstances]) => {
	...
	require_state.createEffect(require_state.on(() => [props.inspectVisible, props.inspectBounds], ([isVisible, bounds]) => {
	...
	return (() => {
		var _el$ = _tmpl$$29();
		var _ref$ = canvasRef;
		typeof _ref$ === "function" ? require_state.use(_ref$, _el$) : canvasRef = _el$;
		require_state.createRenderEffect((_$p) => require_state.setStyleProperty(_el$, "z-index", String(require_freeze_updates.Z_INDEX_OVERLAY_CANVAS)));
		return _el$;
	})();
};
...
var _tmpl$$28 = /* @__PURE__ */ require_state.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 12 12"fill=none><path d="M6 1L6 11M6 1L2 5M6 1L10 5"stroke=currentColor stroke-width=1.5 stroke-linecap=round stroke-linejoin=round>`);
const IconSubmit = (props) => {
	const size = () => props.size ?? 12;
	return (() => {
		var _el$ = _tmpl$$28();
		require_state.createRenderEffect((_p$) => {
			var _v$ = size(), _v$2 = size(), _v$3 = props.class;
			_v$ !== _p$.e && require_state.setAttribute(_el$, "width", _p$.e = _v$);
			_v$2 !== _p$.t && require_state.setAttribute(_el$, "height", _p$.t = _v$2);
			_v$3 !== _p$.a && require_state.setAttribute(_el$, "class", _p$.a = _v$3);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
var _tmpl$$26 = /* @__PURE__ */ require_state.template(`<div data-react-grab-arrow class="absolute w-0 h-0 z-10">`);
const Arrow = (props) => {
	...
	return (() => {
		...
		require_state.createRenderEffect((_p$) => {
			...
			_v$ !== _p$.e && require_state.setStyleProperty(_el$, "left", _p$.e = _v$);
			_v$2 !== _p$.t && require_state.setStyleProperty(_el$, "top", _p$.t = _v$2);
			_v$3 !== _p$.a && require_state.setStyleProperty(_el$, "bottom", _p$.a = _v$3);
			_v$4 !== _p$.o && require_state.setStyleProperty(_el$, "transform", _p$.o = _v$4);
			_v$5 !== _p$.i && require_state.setStyleProperty(_el$, "border-left", _p$.i = _v$5);
			_v$6 !== _p$.n && require_state.setStyleProperty(_el$, "border-right", _p$.n = _v$6);
			_v$7 !== _p$.s && require_state.setStyleProperty(_el$, "border-bottom", _p$.s = _v$7);
			_v$8 !== _p$.h && require_state.setStyleProperty(_el$, "border-top", _p$.h = _v$8);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
var _tmpl$$25 = /* @__PURE__ */ require_state.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-linecap=round stroke-linejoin=round stroke-width=2><path d="M12 6H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6"></path><path d="M11 13l9-9"></path><path d="M15 4h5v5">`);
...
var _tmpl$$24 = /* @__PURE__ */ require_state.template(`<span class=text-black>`), _tmpl$2$10 = /* @__PURE__ */ require_state.template(`<span class=text-black/50>.`), _tmpl$3$7 = /* @__PURE__ */ require_state.template(`<div><span class="text-[13px] leading-4 h-fit font-medium overflow-hidden text-ellipsis whitespace-nowrap min-w-0">`);
const TagBadge = (props) => {
	const [isHovered, setIsHovered] = require_state.createSignal(false);
	...
	return (() => {
		...
		require_state.addEventListener(_el$, "click", props.onClick, true);
		_el$.addEventListener("mouseleave", handleMouseLeave);
		_el$.addEventListener("mouseenter", handleMouseEnter);
		require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
			get when() {
			...
			get children() {
				return [(() => {
					var _el$3 = _tmpl$$24();
					require_state.insert(_el$3, () => props.componentName);
					return _el$3;
				})(), (() => {
					var _el$4 = _tmpl$2$10();
					_el$4.firstChild;
					require_state.insert(_el$4, () => props.tagName, null);
					return _el$4;
				})()];
			}
		}), null);
		require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
			...
			get children() {
				var _el$6 = _tmpl$$24();
				require_state.insert(_el$6, () => props.tagName);
				return _el$6;
			}
		}), null);
		require_state.insert(_el$, require_state.createComponent(require_state.Show, {
			get when() {
				return props.isClickable || props.forceShowIcon;
			},
			get children() {
				return require_state.createComponent(IconOpen, {
					size: 10,
					get ["class"]() {
		...
		require_state.createRenderEffect(() => require_state.className(_el$, cn("contain-layout flex items-center gap-1 max-w-[280px] overflow-hidden", props.shrink && "shrink-0", props.isClickable && "cursor-pointer")));
		return _el$;
	})();
};
require_state.delegateEvents(["click"]);

//#endregion
//#region src/components/selection-label/bottom-section.tsx
var _tmpl$$23 = /* @__PURE__ */ require_state.template(`<div class="[font-synthesis:none] contain-layout shrink-0 flex flex-col items-start px-2 py-1.5 w-auto h-fit self-stretch [border-top-width:0.5px] border-t-solid border-t-[#D9D9D9] antialiased rounded-t-none rounded-b-[6px]">`);
const BottomSection = (props) => (() => {
	var _el$ = _tmpl$$23();
	require_state.insert(_el$, () => props.children);
	return _el$;
})();
...
const DiscardPrompt = (props) => {
	...
	return (() => {
		...
		require_state.insert(_el$3, () => props.label ?? "Discard?");
		require_state.insert(_el$, require_state.createComponent(BottomSection, { get children() {
			var _el$4 = _tmpl$$21(), _el$5 = _el$4.firstChild, _el$6 = _el$5.nextSibling;
			_el$6.firstChild;
			require_state.addEventListener(_el$5, "click", props.onCancel, true);
			require_state.addEventListener(_el$6, "click", props.onConfirm, true);
			require_state.insert(_el$6, require_state.createComponent(IconReturn, {
				size: 10,
...
require_state.delegateEvents(["pointerdown", "click"]);

//#endregion
//#region src/components/icons/icon-retry.tsx
var _tmpl$$20 = /* @__PURE__ */ require_state.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4C7.58 4 4.01 7.58 4.01 12C4.01 16.42 7.58 20 12 20C15.73 20 18.84 17.45 19.73 14H17.65C16.83 16.33 14.61 18 12 18C8.69 18 6 15.31 6 12C6 8.69 8.69 6 12 6C13.66 6 15.14 6.69 16.22 7.78L13 11H20V4L17.65 6.35Z"fill=currentColor>`);
...
const ErrorView = (props) => {
	...
	return (() => {
		...
		_el$.$$click = handleFocus;
		_el$.$$pointerdown = handleFocus;
		require_state.insert(_el$3, () => props.error);
		require_state.insert(_el$, require_state.createComponent(require_state.Show, {
			get when() {
				return hasActions();
			},
			get children() {
				return require_state.createComponent(BottomSection, { get children() {
					var _el$4 = _tmpl$$19(), _el$5 = _el$4.firstChild;
					_el$5.firstChild;
					var _el$7 = _el$5.nextSibling;
					require_state.addEventListener(_el$5, "click", props.onRetry, true);
					require_state.insert(_el$5, require_state.createComponent(IconRetry, {
						size: 10,
						"class": "text-black/50"
					}), null);
					require_state.addEventListener(_el$7, "click", props.onAcknowledge, true);
					return _el$4;
				} });
			}
		}), null);
		require_state.createRenderEffect((_p$) => {
			...
			_p$.e = require_state.classList(_el$2, _v$, _p$.e);
			_v$2 !== _p$.t && require_state.setAttribute(_el$3, "title", _p$.t = _v$2);
			return _p$;
		}, {
			e: void 0,
			t: void 0
...
var _tmpl$$18 = /* @__PURE__ */ require_state.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=currentColor><circle cx=5 cy=12 r=2></circle><circle cx=12 cy=12 r=2></circle><circle cx=19 cy=12 r=2>`);
...
var _tmpl$$16 = /* @__PURE__ */ require_state.template(`<button data-react-grab-ignore-events data-react-grab-more-options class="flex items-center justify-center size-[18px] rounded-sm cursor-pointer bg-transparent hover:bg-black/10 text-black/30 hover:text-black border-none outline-none p-0 shrink-0 press-scale">`), _tmpl$2$7 = /* @__PURE__ */ require_state.template(`<button data-react-grab-dismiss class="contain-layout shrink-0 flex items-center justify-center gap-1 px-[3px] py-px rounded-sm bg-white [border-width:0.5px] border-solid border-[#B3B3B3] cursor-pointer transition-all hover:bg-[#F5F5F5] press-scale h-[17px]"><span class="text-black text-[13px] leading-3.5 font-sans font-medium">Keep`), _tmpl$3$6 = /* @__PURE__ */ require_state.template(`<div class="contain-layout shrink-0 flex items-center justify-between gap-2 pt-1.5 pb-1 px-2 w-full h-fit"><span class="text-black text-[13px] leading-4 font-sans font-medium h-fit tabular-nums overflow-hidden text-ellipsis whitespace-nowrap min-w-0"></span><div class="contain-layout shrink-0 flex items-center gap-2 h-fit">`), _tmpl$4$4 = /* @__PURE__ */ require_state.template(`<div class="contain-layout shrink-0 flex items-center gap-0.5 py-1.5 px-2 w-full h-fit"><span class="text-black text-[13px] leading-4 font-sans font-medium h-fit tabular-nums overflow-hidden text-ellipsis whitespace-nowrap min-w-0">`), _tmpl$5$3 = /* @__PURE__ */ require_state.template(`<div data-react-grab-completion>`);
const MoreOptionsButton = (props) => {
	return (() => {
		var _el$ = _tmpl$$16();
		require_state.addEventListener(_el$, "click", (event) => {
			event.stopImmediatePropagation();
			props.onClick();
		});
		require_state.addEventListener(_el$, "pointerdown", (event) => {
			event.stopImmediatePropagation();
		});
		require_state.insert(_el$, require_state.createComponent(IconEllipsis, { size: 14 }));
		return _el$;
	})();
};
const CompletionView = (props) => {
	...
	const [didCopy, setDidCopy] = require_state.createSignal(false);
	const [isFading, setIsFading] = require_state.createSignal(false);
	...
	return (() => {
		...
		require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
			get when() {
				return require_state.memo(() => !!!didCopy())() && props.onDismiss;
			},
			get children() {
				var _el$3 = _tmpl$3$6(), _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling;
				require_state.insert(_el$4, displayStatusText);
				require_state.insert(_el$5, require_state.createComponent(require_state.Show, {
					get when() {
						return props.onShowContextMenu;
					},
					get children() {
						return require_state.createComponent(MoreOptionsButton, { onClick: handleShowContextMenu });
					}
				}), null);
				require_state.insert(_el$5, require_state.createComponent(require_state.Show, {
					get when() {
					...
					get children() {
						...
						require_state.insert(_el$6, require_state.createComponent(require_state.Show, {
							get when() {
								return !didCopy();
							},
							get children() {
								return require_state.createComponent(IconReturn, {
									size: 10,
									"class": "text-black/50"
								});
							}
						}), null);
						require_state.createRenderEffect(() => _el$6.disabled = didCopy());
						return _el$6;
					}
				}), null);
				return _el$3;
		...
		require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
			...
			get children() {
				...
				require_state.insert(_el$8, require_state.createComponent(IconCheck, {
					size: 14,
					"class": "text-black/85 shrink-0 animate-success-pop"
				}), _el$9);
				require_state.insert(_el$9, displayStatusText);
				require_state.insert(_el$8, require_state.createComponent(require_state.Show, {
					get when() {
						return props.onShowContextMenu;
					},
					get children() {
		...
		require_state.createRenderEffect((_p$) => {
			...
			_v$ !== _p$.e && require_state.className(_el$2, _p$.e = _v$);
			_v$2 !== _p$.t && require_state.setStyleProperty(_el$2, "opacity", _p$.t = _v$2);
			return _p$;
		}, {
			e: void 0,
			t: void 0
...
const ArrowNavigationMenu = (props) => {
	...
	return require_state.createComponent(BottomSection, { get children() {
		...
		require_state.use((element) => {
			menuItemsRef = element;
			highlightContainerRef(element);
		}, _el$);
		require_state.use(highlightRef, _el$2);
		require_state.insert(_el$, require_state.createComponent(require_state.For, {
			get each() {
				return props.items;
			},
			children: (item, itemIndex) => (() => {
				...
				require_state.insert(_el$4, require_state.createComponent(require_state.Show, {
					get when() {
						return item.componentName;
					},
					get children() {
						return [require_state.memo(() => item.componentName), _tmpl$2$6()];
					}
				}), null);
				require_state.insert(_el$4, () => item.tagName, null);
				require_state.createRenderEffect((_p$) => {
					var _v$ = item.tagName, _v$2 = itemIndex(), _v$3 = !!(itemIndex() === props.activeIndex), _v$4 = !!(itemIndex() !== props.activeIndex);
					_v$ !== _p$.e && require_state.setAttribute(_el$3, "data-react-grab-arrow-nav-item", _p$.e = _v$);
					_v$2 !== _p$.t && require_state.setAttribute(_el$3, "data-react-grab-arrow-nav-index", _p$.t = _v$2);
...
var _tmpl$$14 = /* @__PURE__ */ require_state.template(`<div class="contain-layout shrink-0 flex flex-col justify-center items-start w-fit h-fit max-w-[280px]"><div class="contain-layout shrink-0 flex items-center gap-1 py-1.5 px-2 w-full h-fit"><span class="shimmer-text text-[13px] leading-4 font-sans font-medium h-fit tabular-nums overflow-hidden text-ellipsis whitespace-nowrap">`), _tmpl$2$5 = /* @__PURE__ */ require_state.template(`<div class="flex flex-col w-[calc(100%+16px)] -mx-2 -my-1.5">`), _tmpl$3$4 = /* @__PURE__ */ require_state.template(`<div class="contain-layout shrink-0 flex flex-col items-start w-fit h-fit"><div class="contain-layout shrink-0 flex items-center gap-1 w-fit h-fit px-2">`), _tmpl$4$3 = /* @__PURE__ */ require_state.template(`<button data-react-grab-submit class="contain-layout shrink-0 flex items-center justify-center size-4 rounded-full bg-black cursor-pointer ml-1 interactive-scale">`), _tmpl$5$2 = /* @__PURE__ */ require_state.template(`<div class="shrink-0 flex justify-between items-end w-full min-h-4"><textarea data-react-grab-ignore-events data-react-grab-input class="text-black text-[13px] leading-4 font-medium bg-transparent border-none outline-none resize-none flex-1 p-0 m-0 wrap-break-word overflow-y-auto"placeholder="Add context"rows=1 style=field-sizing:content;min-height:16px;scrollbar-width:none>`), _tmpl$6$1 = /* @__PURE__ */ require_state.template(`<div class="contain-layout shrink-0 flex flex-col justify-center items-start w-fit h-fit min-w-[150px] max-w-[280px]"><div class="contain-layout shrink-0 flex items-center gap-1 pt-1.5 pb-1 w-fit h-fit px-2 max-w-full">`), _tmpl$7$1 = /* @__PURE__ */ require_state.template(`<div data-react-grab-ignore-events data-react-grab-selection-label><div>`), _tmpl$8$1 = /* @__PURE__ */ require_state.template(`<span class="text-[11px] font-sans text-black/50 ml-4">`), _tmpl$9$1 = /* @__PURE__ */ require_state.template(`<div class="contain-layout flex items-center justify-between w-full px-2 py-1 transition-colors"><span class="text-[13px] leading-4 font-sans font-medium text-black">`);
...
const SelectionLabel = (props) => {
	...
	const [measuredWidth, setMeasuredWidth] = require_state.createSignal(0);
	const [measuredHeight, setMeasuredHeight] = require_state.createSignal(0);
	const [panelWidth, setPanelWidth] = require_state.createSignal(0);
	const [viewportVersion, setViewportVersion] = require_state.createSignal(0);
	const [isInternalFading, setIsInternalFading] = require_state.createSignal(false);
	const [isShaking, setIsShaking] = require_state.createSignal(false);
	...
	const positionComputation = require_state.createMemo((previousResult) => {
		viewportVersion();
	...
	require_state.createEffect(require_state.on(() => props.selectionLabelShakeCount, () => setIsShaking(true), { defer: true }));
	const handleKeyDown = (event) => {
	...
	return require_state.createComponent(require_state.Show, {
		get when() {
			return require_state.memo(() => props.visible !== false)() && (props.selectionBounds || shouldPersistDuringFade());
		},
		get children() {
			...
			typeof _ref$ === "function" ? require_state.use(_ref$, _el$) : containerRef = _el$;
			require_state.setStyleProperty(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			require_state.insert(_el$, require_state.createComponent(require_state.Show, {
				get when() {
					return !props.hideArrow;
				},
				get children() {
					return require_state.createComponent(Arrow, {
						get position() {
			...
			require_state.insert(_el$, require_state.createComponent(require_state.Show, {
				get when() {
					return require_state.memo(() => !!isCompletedStatus())() && !props.error;
				},
				get children() {
					return require_state.createComponent(CompletionView, {
						get statusText() {
			...
			var _ref$2 = panelRef;
			typeof _ref$2 === "function" ? require_state.use(_ref$2, _el$2) : panelRef = _el$2;
			require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
				get when() {
				...
				get children() {
					...
					require_state.insert(_el$4, require_state.createComponent(IconLoader, {
						size: 13,
						"class": "text-[#71717a] shrink-0"
					}), _el$5);
					require_state.insert(_el$5, () => props.statusText ?? "Grabbing…");
					return _el$3;
				}
			}), null);
			require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
				get when() {
					return require_state.memo(() => !!canInteract())() && !props.isPromptMode;
				},
				get children() {
					var _el$6 = _tmpl$3$4(), _el$7 = _el$6.firstChild;
					require_state.insert(_el$7, require_state.createComponent(TagBadge, {
						get tagName() {
						...
						shrink: true,
						get forceShowIcon() {
							return require_state.memo(() => !!(isArrowNavigationVisible() || isInspectNavigationVisible()))() ? Boolean(props.filePath && props.onOpen) : Boolean(props.isContextMenuOpen);
						}
					}));
					require_state.insert(_el$6, require_state.createComponent(require_state.Show, {
						get when() {
						...
						get children() {
							return require_state.createComponent(ArrowNavigationMenu, {
								get items() {
					...
					require_state.insert(_el$6, require_state.createComponent(require_state.Show, {
						get when() {
							return require_state.memo(() => !!(!isArrowNavigationVisible() && isInspectNavigationVisible()))() && props.inspectNavigationState;
						},
						children: (state) => require_state.createComponent(ArrowNavigationMenu, {
							get items() {
								return state().items;
							},
							get activeIndex() {
					...
					require_state.insert(_el$6, require_state.createComponent(require_state.Show, {
						get when() {
							return require_state.memo(() => !!(!isArrowNavigationVisible() && !isInspectNavigationVisible()))() && Boolean(props.actionCycleState?.isVisible);
						},
						get children() {
							return require_state.createComponent(BottomSection, { get children() {
								var _el$8 = _tmpl$2$5();
								require_state.insert(_el$8, require_state.createComponent(require_state.For, {
									get each() {
										return props.actionCycleState?.items ?? [];
									},
									children: (item, itemIndex) => (() => {
										var _el$12 = _tmpl$9$1(), _el$13 = _el$12.firstChild;
										require_state.insert(_el$13, () => item.label);
										require_state.insert(_el$12, require_state.createComponent(require_state.Show, {
											get when() {
												return item.shortcut;
											},
											get children() {
												var _el$14 = _tmpl$8$1();
												require_state.insert(_el$14, () => formatShortcut(item.shortcut));
												return _el$14;
											}
										}), null);
										require_state.createRenderEffect((_p$) => {
											...
											_v$1 !== _p$.e && require_state.setAttribute(_el$12, "data-react-grab-action-cycle-item", _p$.e = _v$1);
					...
					require_state.createRenderEffect((_p$) => {
						...
						_p$.t = require_state.classList(_el$7, _v$2, _p$.t);
						return _p$;
					}, {
						e: void 0,
						t: void 0
			...
			require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
				get when() {
					return require_state.memo(() => !!(canInteract() && props.isPromptMode))() && !props.isPendingDismiss;
				},
				get children() {
					var _el$9 = _tmpl$6$1(), _el$0 = _el$9.firstChild;
					require_state.insert(_el$0, require_state.createComponent(TagBadge, {
						get tagName() {
							return tagDisplayResult().tagName;
						},
						get componentName() {
					...
					require_state.insert(_el$9, require_state.createComponent(BottomSection, { get children() {
						...
						require_state.setStyleProperty(_el$10, "max-height", `${95}px`);
						require_state.insert(_el$1, require_state.createComponent(require_state.Show, {
							get when() {
							...
							get children() {
								...
								require_state.insert(_el$11, require_state.createComponent(IconSubmit, {
									size: 10,
									"class": "text-white"
								}));
								return _el$11;
						...
						require_state.createRenderEffect(() => _el$10.readOnly = !props.onSubmit);
						require_state.createRenderEffect(() => _el$10.value = props.inputValue ?? "");
						return _el$1;
					} }), null);
					return _el$9;
				}
			...
			require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
				...
				get children() {
					return require_state.createComponent(DiscardPrompt, {
						get onConfirm() {
			...
			require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
				...
				get children() {
					return require_state.createComponent(ErrorView, {
						get error() {
							return props.error;
						},
						get onAcknowledge() {
			...
			require_state.createRenderEffect((_p$) => {
				...
				_v$3 !== _p$.e && require_state.className(_el$, _p$.e = _v$3);
				_v$4 !== _p$.t && require_state.setStyleProperty(_el$, "top", _p$.t = _v$4);
				_v$5 !== _p$.a && require_state.setStyleProperty(_el$, "left", _p$.a = _v$5);
				_v$6 !== _p$.o && require_state.setStyleProperty(_el$, "transform", _p$.o = _v$6);
				_v$7 !== _p$.i && require_state.setStyleProperty(_el$, "pointer-events", _p$.i = _v$7);
				_v$8 !== _p$.n && require_state.setStyleProperty(_el$, "opacity", _p$.n = _v$8);
				_v$9 !== _p$.s && require_state.className(_el$2, _p$.s = _v$9);
				_v$0 !== _p$.h && require_state.setStyleProperty(_el$2, "display", _p$.h = _v$0);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
var _tmpl$$10 = /* @__PURE__ */ require_state.template(`<div>`);
let lastCloseTimestamp = 0;
const wasTooltipRecentlyVisible = () => {
	return Date.now() - lastCloseTimestamp < 100;
};
const Tooltip = (props) => {
	const [delayedVisible, setDelayedVisible] = require_state.createSignal(false);
	const [shouldAnimate, setShouldAnimate] = require_state.createSignal(true);
	let delayTimeoutId;
	require_state.createEffect(require_state.on(() => props.visible, (isVisible) => {
	...
	return require_state.createComponent(require_state.Show, {
		...
		get children() {
			...
			require_state.createRenderEffect((_p$) => {
				...
				_v$ !== _p$.e && require_state.className(_el$, _p$.e = _v$);
				_p$.t = require_state.style(_el$, _v$2, _p$.t);
				return _p$;
			}, {
				e: void 0,
				t: void 0
...
var _tmpl$$9 = /* @__PURE__ */ require_state.template(`<kbd class="inline-flex items-center justify-center px-[3px] h-3.5 rounded-sm [border-width:0.5px] border-solid border-[#B3B3B3] text-black/70 text-[10px] font-medium leading-none">`);
const Kbd = (props) => (() => {
	var _el$ = _tmpl$$9();
	require_state.insert(_el$, () => props.children);
	return _el$;
...
var _tmpl$$8 = /* @__PURE__ */ require_state.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2.5 stroke-linecap=round stroke-linejoin=round><path d="m18 15-6-6-6 6">`);
...
var _tmpl$$7 = /* @__PURE__ */ require_state.template(`<button data-react-grab-ignore-events data-react-grab-toolbar-collapse class="contain-layout shrink-0 flex items-center justify-center cursor-pointer interactive-scale">`), _tmpl$2$4 = /* @__PURE__ */ require_state.template(`<div><div><div><div><div><div></div></div><div><div></div></div><div><div></div></div></div><div class="relative shrink-0 overflow-visible">`);
const ToolbarContent = (props) => {
	...
	const defaultCollapseButton = () => (() => {
		var _el$ = _tmpl$$7();
		require_state.addEventListener(_el$, "click", props.onCollapseClick, true);
		require_state.insert(_el$, require_state.createComponent(IconChevron, {
			size: 14,
			get ["class"]() {
				return cn("text-[#B3B3B3] transition-transform duration-150", chevronRotation());
			}
		}));
		require_state.createRenderEffect(() => require_state.setAttribute(_el$, "aria-label", props.isCollapsed ? "Expand toolbar" : "Collapse toolbar"));
		return _el$;
	})();
	return (() => {
		...
		require_state.addEventListener(_el$2, "click", props.onPanelClick, true);
		require_state.addEventListener(_el$2, "animationend", props.onAnimationEnd);
		require_state.use((element) => props.onExpandableButtonsRef?.(element), _el$5);
		require_state.insert(_el$7, () => props.selectButton);
		require_state.insert(_el$9, () => props.commentsButton);
		require_state.insert(_el$1, () => props.copyAllButton);
		require_state.insert(_el$10, () => props.toggleButton);
		require_state.insert(_el$2, () => props.collapseButton ?? defaultCollapseButton(), null);
		require_state.createRenderEffect((_p$) => {
			...
			_v$ !== _p$.e && require_state.className(_el$2, _p$.e = _v$);
			_v$2 !== _p$.t && require_state.setStyleProperty(_el$2, "transform-origin", _p$.t = _v$2);
			_v$3 !== _p$.a && require_state.className(_el$3, _p$.a = _v$3);
			_v$4 !== _p$.o && require_state.className(_el$4, _p$.o = _v$4);
			_v$5 !== _p$.i && require_state.className(_el$5, _p$.i = _v$5);
			_v$6 !== _p$.n && require_state.className(_el$6, _p$.n = _v$6);
			_v$7 !== _p$.s && require_state.className(_el$7, _p$.s = _v$7);
			_v$8 !== _p$.h && require_state.className(_el$8, _p$.h = _v$8);
			_v$9 !== _p$.r && require_state.className(_el$9, _p$.r = _v$9);
			_v$0 !== _p$.d && require_state.className(_el$0, _p$.d = _v$0);
			_v$1 !== _p$.l && require_state.className(_el$1, _p$.l = _v$1);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
const createToolbarDrag = (config) => {
	const [isDragging, setIsDragging] = require_state.createSignal(false);
	const [isSnapping, setIsSnapping] = require_state.createSignal(false);
	const [hasDragMoved, setHasDragMoved] = require_state.createSignal(false);
	const [velocity, setVelocity] = require_state.createSignal({
		x: 0,
		y: 0
	});
	let dragOffset = {
...
var _tmpl$$6 = /* @__PURE__ */ require_state.template(`<span>Click or<!>to capture`), _tmpl$2$3 = /* @__PURE__ */ require_state.template(`<span>to fine-tune target`), _tmpl$3$3 = /* @__PURE__ */ require_state.template(`<span>to cancel`), _tmpl$4$2 = /* @__PURE__ */ require_state.template(`<div>`), _tmpl$5$1 = /* @__PURE__ */ require_state.template(`<div>Enable to continue`), _tmpl$6 = /* @__PURE__ */ require_state.template(`<div data-react-grab-ignore-events data-react-grab-toolbar>`), _tmpl$7 = /* @__PURE__ */ require_state.template(`<button data-react-grab-ignore-events data-react-grab-toolbar-toggle>`), _tmpl$8 = /* @__PURE__ */ require_state.template(`<span data-react-grab-unread-indicator class="absolute -top-1 -right-1 min-w-2.5 h-2.5 px-0.5 flex items-center justify-center rounded-full bg-black text-white text-[8px] font-semibold leading-none">`), _tmpl$9 = /* @__PURE__ */ require_state.template(`<button data-react-grab-ignore-events data-react-grab-toolbar-comments aria-haspopup=menu><span class="inline-flex relative">`), _tmpl$0 = /* @__PURE__ */ require_state.template(`<button data-react-grab-ignore-events data-react-grab-toolbar-copy-all aria-label="Copy all comments">`), _tmpl$1 = /* @__PURE__ */ require_state.template(`<button data-react-grab-ignore-events data-react-grab-toolbar-enabled><div><div>`);
const Toolbar = (props) => {
	let containerRef;
	...
	const [isVisible, setIsVisible] = require_state.createSignal(false);
	const [isCollapsed, setIsCollapsed] = require_state.createSignal(false);
	const [isResizing, setIsResizing] = require_state.createSignal(false);
	const [snapEdge, setSnapEdge] = require_state.createSignal(savedState?.edge ?? "bottom");
	const [positionRatio, setPositionRatio] = require_state.createSignal(savedState?.ratio ?? .5);
	const [position, setPosition] = require_state.createSignal({
		x: 0,
		y: 0
	});
	const [isShaking, setIsShaking] = require_state.createSignal(false);
	const [isCollapseAnimating, setIsCollapseAnimating] = require_state.createSignal(false);
	const [isSelectTooltipVisible, setIsSelectTooltipVisible] = require_state.createSignal(false);
	const [isToggleTooltipVisible, setIsToggleTooltipVisible] = require_state.createSignal(false);
	const [isShakeTooltipVisible, setIsShakeTooltipVisible] = require_state.createSignal(false);
	const [isToggleAnimating, setIsToggleAnimating] = require_state.createSignal(false);
	const [isRapidRetoggle, setIsRapidRetoggle] = require_state.createSignal(false);
	const [isCommentsTooltipVisible, setIsCommentsTooltipVisible] = require_state.createSignal(false);
	const [isCopyAllTooltipVisible, setIsCopyAllTooltipVisible] = require_state.createSignal(false);
	let clockFlashRef;
	const [selectionHintIndex, setSelectionHintIndex] = require_state.createSignal(0);
	const [hasHintCycled, setHasHintCycled] = require_state.createSignal(false);
	...
	require_state.createEffect(require_state.on(() => [props.isActive, hasLearnedSelectionHints()], ([isActive, hasLearned]) => {
	...
	require_state.createEffect(require_state.on(() => props.shakeCount, (count) => {
	...
	require_state.createEffect(require_state.on(() => props.enabled, (enabled) => {
		if (enabled && isShakeTooltipVisible()) {
			setIsShakeTooltipVisible(false);
			clearShakeTooltipTimeout();
		}
	}));
	require_state.createEffect(require_state.on(() => [props.isActive, props.isContextMenuOpen], ([isActive, isContextMenuOpen]) => {
	...
	require_state.createEffect(require_state.on(() => props.clockFlashTrigger ?? 0, () => {
	...
	require_state.createEffect(require_state.on(() => props.commentItemCount ?? 0, () => {
	...
	const [collapsedDimensions, setCollapsedDimensions] = require_state.createSignal({
		width: 14,
		height: 14
	});
	...
	require_state.onMount(() => {
		...
		if (props.enabled) measureExpandableDimension();
		if (props.onSubscribeToStateChanges) require_state.onCleanup(props.onSubscribeToStateChanges((state) => {
	...
	return (() => {
		...
		require_state.addEventListener(_el$, "mousedown", stopEventPropagation);
		require_state.addEventListener(_el$, "pointerdown", (event) => {
		...
		var _ref$ = containerRef;
		typeof _ref$ === "function" ? require_state.use(_ref$, _el$) : containerRef = _el$;
		require_state.insert(_el$, require_state.createComponent(ToolbarContent, {
			get isActive() {
			...
			get selectButton() {
				return [(() => {
					var _el$10 = _tmpl$7();
					require_state.addEventListener(_el$10, "contextmenu", (event) => {
						event.preventDefault();
						event.stopPropagation();
					...
					require_state.spread(_el$10, require_state.mergeProps({
						get ["aria-label"]() {
					...
					require_state.insert(_el$10, require_state.createComponent(IconSelect, {
						size: 14,
						get ["class"]() {
					...
					return _el$10;
				})(), require_state.createComponent(Tooltip, {
					get visible() {
						return require_state.memo(() => !!isSelectTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
					get children() {
						return ["Select element ", require_state.createComponent(Kbd, { get children() {
			...
			get commentsButton() {
				return [(() => {
					...
					require_state.spread(_el$11, require_state.mergeProps({
						get ["aria-label"]() {
					...
					typeof _ref$2 === "function" ? require_state.use(_ref$2, _el$12) : clockFlashRef = _el$12;
					require_state.insert(_el$12, require_state.createComponent(IconComment, {
						size: 14,
						get ["class"]() {
					...
					require_state.insert(_el$12, require_state.createComponent(require_state.Show, {
						...
						get children() {
							var _el$13 = _tmpl$8();
							require_state.insert(_el$13, () => props.commentItemCount);
							return _el$13;
						}
					}), null);
					return _el$11;
					...
					get visible() {
						return require_state.memo(() => !!isCommentsTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
			...
			get copyAllButton() {
				return [(() => {
					...
					require_state.spread(_el$14, require_state.mergeProps({ get ["class"]() {
						return cn("contain-layout flex items-center justify-center cursor-pointer interactive-scale touch-hitbox", buttonSpacingClass(), hitboxConstraintClass());
					...
					require_state.insert(_el$14, require_state.createComponent(IconCopy, {
						size: 14,
					...
					get visible() {
						return require_state.memo(() => !!isCopyAllTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
			...
			get toggleButton() {
				return [(() => {
					...
					require_state.createRenderEffect((_p$) => {
						...
						_v$9 !== _p$.e && require_state.setAttribute(_el$15, "aria-label", _p$.e = _v$9);
						_v$0 !== _p$.t && require_state.setAttribute(_el$15, "aria-pressed", _p$.t = _v$0);
						_v$1 !== _p$.a && require_state.className(_el$15, _p$.a = _v$1);
						_v$10 !== _p$.o && require_state.className(_el$16, _p$.o = _v$10);
						_v$11 !== _p$.i && require_state.className(_el$17, _p$.i = _v$11);
						return _p$;
					}, {
						e: void 0,
						t: void 0,
					...
					get visible() {
						return require_state.memo(() => !!isToggleTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
		...
		require_state.insert(_el$, require_state.createComponent(require_state.Show, {
			...
			get children() {
				return [require_state.createComponent(require_state.Show, {
					get when() {
						return require_state.memo(() => !!props.isActive)() && !hasLearnedSelectionHints();
					},
					get children() {
						var _el$2 = _tmpl$4$2();
						require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
							...
							get children() {
								...
								_el$6.nextSibling;
								require_state.insert(_el$3, require_state.createComponent(Kbd, { children: "↵" }), _el$6);
								require_state.createRenderEffect(() => require_state.className(_el$3, cn("flex items-center gap-1", hasHintCycled() && "animate-[hint-flip-in_var(--transition-normal)_ease-out]")));
								return _el$3;
							}
						}), null);
						require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
							...
							get children() {
								...
								require_state.insert(_el$7, require_state.createComponent(Kbd, { children: "↑" }), _el$8);
								require_state.insert(_el$7, require_state.createComponent(Kbd, { children: "↓" }), _el$8);
								require_state.createRenderEffect(() => require_state.className(_el$7, cn("flex items-center gap-1", require_freeze_updates.HINT_FLIP_IN_ANIMATION)));
								return _el$7;
							}
						}), null);
						require_state.insert(_el$2, require_state.createComponent(require_state.Show, {
							...
							get children() {
								...
								require_state.insert(_el$9, require_state.createComponent(Kbd, { children: "esc" }), _el$0);
								require_state.createRenderEffect(() => require_state.className(_el$9, cn("flex items-center gap-1", require_freeze_updates.HINT_FLIP_IN_ANIMATION)));
								return _el$9;
							}
						}), null);
						require_state.createRenderEffect((_p$) => {
							...
							_v$ !== _p$.e && require_state.className(_el$2, _p$.e = _v$);
							_p$.t = require_state.style(_el$2, _v$2, _p$.t);
							return _p$;
						}, {
							e: void 0,
							t: void 0
				...
				}), require_state.createComponent(require_state.Show, {
					get when() {
					...
					get children() {
						...
						require_state.createRenderEffect((_p$) => {
							...
							_v$3 !== _p$.e && require_state.className(_el$1, _p$.e = _v$3);
							_p$.t = require_state.style(_el$1, _v$4, _p$.t);
							return _p$;
						}, {
							e: void 0,
							t: void 0
		...
		require_state.createRenderEffect((_p$) => {
			...
			_v$5 !== _p$.e && require_state.className(_el$, _p$.e = _v$5);
			_v$6 !== _p$.t && require_state.setStyleProperty(_el$, "z-index", _p$.t = _v$6);
			_v$7 !== _p$.a && require_state.setStyleProperty(_el$, "transform", _p$.a = _v$7);
			_v$8 !== _p$.o && require_state.setStyleProperty(_el$, "transform-origin", _p$.o = _v$8);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
var _tmpl$$5 = /* @__PURE__ */ require_state.template(`<div class="relative flex flex-col w-[calc(100%+16px)] -mx-2 -my-1.5"><div class="pointer-events-none absolute bg-black/5 opacity-0 transition-[top,left,width,height,opacity] duration-75 ease-out">`), _tmpl$2$2 = /* @__PURE__ */ require_state.template(`<div data-react-grab-ignore-events data-react-grab-context-menu class="fixed font-sans text-[13px] antialiased filter-[drop-shadow(0px_1px_2px_#51515140)] select-none"style=pointer-events:auto><div><div class="contain-layout shrink-0 flex items-center gap-1 pt-1.5 pb-1 w-fit h-fit px-2">`), _tmpl$3$2 = /* @__PURE__ */ require_state.template(`<button data-react-grab-ignore-events class="relative z-1 contain-layout flex items-center justify-between w-full px-2 py-1 cursor-pointer text-left border-none bg-transparent disabled:opacity-40 disabled:cursor-default"><span class="text-[13px] leading-4 font-sans font-medium text-black">`), _tmpl$4$1 = /* @__PURE__ */ require_state.template(`<span class="text-[11px] font-sans text-black/50 ml-4">`);
const ContextMenu = (props) => {
	...
	const tagDisplayResult = require_state.createMemo(() => getTagDisplay({
		tagName: props.tagName,
		componentName: props.componentName
	}));
	...
	const computedPosition = require_state.createMemo(() => {
		const bounds = props.selectionBounds;
	...
	const menuItems = require_state.createMemo(() => {
	...
	return require_state.createComponent(require_state.Show, {
		...
		get children() {
			...
			require_state.addEventListener(_el$, "contextmenu", suppressMenuEvent, true);
			require_state.addEventListener(_el$, "click", suppressMenuEvent, true);
			require_state.addEventListener(_el$, "mousedown", suppressMenuEvent, true);
			require_state.addEventListener(_el$, "pointerdown", suppressMenuEvent, true);
			var _ref$ = containerRef;
			typeof _ref$ === "function" ? require_state.use(_ref$, _el$) : containerRef = _el$;
			require_state.setStyleProperty(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			require_state.insert(_el$, require_state.createComponent(Arrow, {
				get position() {
			...
			require_state.insert(_el$3, require_state.createComponent(TagBadge, {
				get tagName() {
					return tagDisplayResult().tagName;
				},
				get componentName() {
			...
			require_state.insert(_el$2, require_state.createComponent(BottomSection, { get children() {
				var _el$4 = _tmpl$$5(), _el$5 = _el$4.firstChild;
				require_state.use(highlightContainerRef, _el$4);
				require_state.use(highlightRef, _el$5);
				require_state.insert(_el$4, require_state.createComponent(require_state.For, {
					get each() {
						return menuItems();
					},
					children: (item) => (() => {
						...
						require_state.addEventListener(_el$6, "pointerleave", clearHighlight);
						...
						require_state.insert(_el$7, () => item.label);
						require_state.insert(_el$6, require_state.createComponent(require_state.Show, {
							get when() {
								return item.shortcut;
							},
							children: (shortcut) => (() => {
								var _el$8 = _tmpl$4$1();
								require_state.insert(_el$8, () => formatShortcut(shortcut()));
								return _el$8;
							})()
						}), null);
						require_state.createRenderEffect((_p$) => {
							var _v$4 = item.label.toLowerCase(), _v$5 = !item.enabled;
							_v$4 !== _p$.e && require_state.setAttribute(_el$6, "data-react-grab-menu-item", _p$.e = _v$4);
			...
			require_state.createRenderEffect((_p$) => {
				...
				_v$ !== _p$.e && require_state.setStyleProperty(_el$, "top", _p$.e = _v$);
				_v$2 !== _p$.t && require_state.setStyleProperty(_el$, "left", _p$.t = _v$2);
				_v$3 !== _p$.a && require_state.className(_el$2, _p$.a = _v$3);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
const createAnchoredDropdown = (containerRef, anchorAccessor) => {
	const [measuredWidth, setMeasuredWidth] = require_state.createSignal(0);
	const [measuredHeight, setMeasuredHeight] = require_state.createSignal(0);
	const [shouldMount, setShouldMount] = require_state.createSignal(false);
	const [isAnimatedIn, setIsAnimatedIn] = require_state.createSignal(false);
	const [viewportVersion, setViewportVersion] = require_state.createSignal(0);
	const [lastAnchorEdge, setLastAnchorEdge] = require_state.createSignal("bottom");
	...
	require_state.createEffect(() => {
		...
		require_state.onCleanup(clearAnimationHandles);
	});
	require_state.createEffect(() => {
	...
	return {
		...
		isAnimatedIn,
		lastAnchorEdge,
		displayPosition: require_state.createMemo((previousPosition) => {
			viewportVersion();
...
const ToolbarMenu = (props) => {
	...
	return require_state.createComponent(require_state.Show, {
		...
		get children() {
			...
			typeof _ref$ === "function" ? require_state.use(_ref$, _el$) : containerRef = _el$;
			require_state.setStyleProperty(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			require_state.setStyleProperty(_el$2, "min-width", `${100}px`);
			require_state.use(highlightContainerRef, _el$3);
			require_state.use(highlightRef, _el$4);
			require_state.insert(_el$3, require_state.createComponent(require_state.For, {
				get each() {
				...
				children: (action) => {
					...
					return (() => {
						...
						require_state.addEventListener(_el$5, "pointerleave", clearHighlight);
						...
						require_state.insert(_el$6, () => action.label);
						require_state.insert(_el$5, require_state.createComponent(require_state.Show, {
							get when() {
							...
							children: (shortcutKey) => (() => {
								var _el$7 = _tmpl$3$1();
								require_state.insert(_el$7, () => formatShortcut(shortcutKey()));
								return _el$7;
							})()
						}), null);
						require_state.createRenderEffect((_p$) => {
							var _v$8 = action.id, _v$9 = cn("text-[13px] leading-4 font-sans font-medium", isDefault() ? "text-black" : "text-black/60");
							_v$8 !== _p$.e && require_state.setAttribute(_el$5, "data-react-grab-menu-item", _p$.e = _v$8);
							_v$9 !== _p$.t && require_state.className(_el$6, _p$.t = _v$9);
							return _p$;
						}, {
							e: void 0,
							t: void 0
			...
			require_state.createRenderEffect((_p$) => {
				...
				_v$ !== _p$.e && require_state.setStyleProperty(_el$, "top", _p$.e = _v$);
				_v$2 !== _p$.t && require_state.setStyleProperty(_el$, "left", _p$.t = _v$2);
				_v$3 !== _p$.a && require_state.setStyleProperty(_el$, "pointer-events", _p$.a = _v$3);
				_v$4 !== _p$.o && require_state.setStyleProperty(_el$, "transform-origin", _p$.o = _v$4);
				_v$5 !== _p$.i && require_state.setStyleProperty(_el$, "opacity", _p$.i = _v$5);
				_v$6 !== _p$.n && require_state.setStyleProperty(_el$, "transform", _p$.n = _v$6);
				_v$7 !== _p$.s && require_state.className(_el$2, _p$.s = _v$7);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
const CommentsDropdown = (props) => {
	...
	const dropdown = createAnchoredDropdown(() => containerRef, () => props.position);
	const [activeHeaderTooltip, setActiveHeaderTooltip] = require_state.createSignal(null);
	const [isCopyAllConfirmed, setIsCopyAllConfirmed] = require_state.createSignal(false);
	let copyAllFeedbackTimeout;
	require_state.createEffect(require_state.on(() => dropdown.isAnimatedIn(), (animatedIn) => {
	...
	return require_state.createComponent(require_state.Show, {
		...
		get children() {
			...
			typeof _ref$ === "function" ? require_state.use(_ref$, _el$) : containerRef = _el$;
			require_state.setStyleProperty(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			require_state.insert(_el$3, require_state.createComponent(require_state.Show, {
				get when() {
				...
				get children() {
					...
					require_state.insert(_el$7, require_state.createComponent(IconTrash, { size: 11 }));
					require_state.insert(_el$6, require_state.createComponent(Tooltip, {
						get visible() {
					...
					require_state.insert(_el$9, require_state.createComponent(require_state.Show, {
						get when() {
						...
						get children() {
							return require_state.createComponent(IconCheck, {
								size: 11,
								"class": "text-black"
							});
						}
					}));
					require_state.insert(_el$8, require_state.createComponent(Tooltip, {
						get visible() {
			...
			require_state.use(highlightContainerRef, _el$1);
			require_state.use(highlightRef, _el$10);
			require_state.insert(_el$1, require_state.createComponent(require_state.For, {
				get each() {
					return props.items;
				},
				children: (item) => (() => {
					var _el$12 = _tmpl$5(), _el$13 = _el$12.firstChild, _el$14 = _el$13.firstChild, _el$16 = _el$13.nextSibling;
					require_state.addEventListener(_el$12, "blur", clearHighlight);
					...
					require_state.insert(_el$14, () => getCommentItemDisplayName(item));
					require_state.insert(_el$13, require_state.createComponent(require_state.Show, {
						get when() {
							return item.commentText;
						},
						get children() {
							var _el$15 = _tmpl$4();
							require_state.insert(_el$15, () => item.commentText);
							return _el$15;
						}
					}), null);
					require_state.insert(_el$16, () => formatRelativeTime(item.timestamp));
					require_state.createRenderEffect((_$p) => require_state.classList(_el$12, { "opacity-40 hover:opacity-100": Boolean(props.disconnectedItemIds?.has(item.id)) }, _$p));
					return _el$12;
				})()
			}), null);
			require_state.createRenderEffect((_p$) => {
				...
				_v$6 !== _p$.n && require_state.setStyleProperty(_el$, "transform", _p$.n = _v$6);
				_v$7 !== _p$.s && require_state.className(_el$2, _p$.s = _v$7);
				_v$8 !== _p$.h && require_state.setStyleProperty(_el$2, "min-width", _p$.h = _v$8);
				_v$9 !== _p$.r && require_state.setStyleProperty(_el$2, "max-width", _p$.r = _v$9);
				_v$0 !== _p$.d && require_state.setStyleProperty(_el$2, "max-height", _p$.d = _v$0);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
var _tmpl$$1 = /* @__PURE__ */ require_state.template(`<div data-react-grab-ignore-events data-react-grab-clear-comments-prompt class="fixed font-sans text-[13px] antialiased filter-[drop-shadow(0px_1px_2px_#51515140)] select-none transition-[opacity,transform] duration-100 ease-out will-change-[opacity,transform]"><div>`);
const ClearCommentsPrompt = (props) => {
	...
	return require_state.createComponent(require_state.Show, {
		...
		get children() {
			...
			typeof _ref$ === "function" ? require_state.use(_ref$, _el$) : containerRef = _el$;
			require_state.setStyleProperty(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			require_state.insert(_el$2, require_state.createComponent(DiscardPrompt, {
...
var _tmpl$ = /* @__PURE__ */ require_state.template(`<div style=position:fixed;top:0;right:0;bottom:0;left:0;pointer-events:none;will-change:opacity;contain:strict;transform:translateZ(0)>`);
const ReactGrabRenderer = (props) => {
	return [
		require_state.createComponent(OverlayCanvas, {
		...
		(() => {
			var _el$ = _tmpl$();
			require_state.setStyleProperty(_el$, "z-index", require_freeze_updates.Z_INDEX_OVERLAY_CANVAS);
			require_state.setStyleProperty(_el$, "transition", `opacity ${100}ms ease-out`);
			require_state.setStyleProperty(_el$, "box-shadow", `inset 0 0 ${50}px ${require_freeze_updates.FROZEN_GLOW_COLOR}`);
			require_state.createRenderEffect((_$p) => require_state.setStyleProperty(_el$, "opacity", props.isFrozen ? 1 : 0));
			return _el$;
		})(),
		require_state.createComponent(require_state.Show, {
			get when() {
				return require_state.memo(() => !!props.selectionLabelVisible)() && props.selectionBounds;
			},
			get children() {
				return require_state.createComponent(SelectionLabel, {
					get tagName() {
		...
		require_state.createComponent(require_state.Index, {
			get each() {
				return props.labelInstances ?? [];
			},
			children: (instance) => require_state.createComponent(SelectionLabel, {
				get tagName() {
		...
		require_state.createComponent(require_state.Show, {
			...
			get children() {
				return require_state.createComponent(Toolbar, {
					get isActive() {
						return props.isActive;
					},
					get isContextMenuOpen() {
		...
		require_state.createComponent(ContextMenu, {
			get position() {
				return props.contextMenuPosition ?? null;
			},
			get selectionBounds() {
		...
		require_state.createComponent(ToolbarMenu, {
			get position() {
		...
		require_state.createComponent(ClearCommentsPrompt, {
			get position() {
		...
		require_state.createComponent(CommentsDropdown, {
			get position() {
