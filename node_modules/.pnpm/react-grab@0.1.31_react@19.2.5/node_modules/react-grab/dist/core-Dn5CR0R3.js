 ...
 */
import { A as $PROXY, B as createResource, C as render, F as batch, G as on, H as createSignal, I as createComponent, K as onCleanup, L as createEffect, R as createMemo, S as memo, U as getListener, V as createRoot, a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, j as $TRACK, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-Bksj8Cmf.js";
import { A as waitUntilNextFrame, I as DEFAULT_ACTION_ID, J as MOUNT_ROOT_RECHECK_DELAY_MS, K as MAX_SESSION_STORAGE_SIZE_BYTES, M as detectCspNonce, N as getTagName, O as nativeCancelAnimationFrame, P as ARROW_KEYS, R as DRAG_SELECTION_COVERAGE_THRESHOLD, S as getNearestComponentName, T as resolveSource, V as FEEDBACK_DURATION_MS, X as OFFSCREEN_POSITION, Y as NEXTJS_REVALIDATION_DELAY_MS, _ as isRootElement, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, ct as TOOLBAR_DEFAULT_POSITION_RATIO, d as freezePseudoStates, dt as VERSION, f as resumePointerEventsFreeze, ft as ZOOM_DETECTION_THRESHOLD, g as isValidGrabbableElement, h as clearVisibilityCache, i as freezeAnimations, j as hideFromThirdParties, k as nativeRequestAnimationFrame, l as getElementAtPosition, m as unfreezePseudoStates, n as logRecoverableError, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, pt as Z_INDEX_OVERLAY, q as MODIFIER_KEYS, r as freezeAllAnimations, s as openFile, t as freezeUpdates, u as getElementsAtPoint, v as checkIsNextProject, w as getStackContext, y as getComponentDisplayName } from "./freeze-updates-BAsixjhH.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-JiRn0tuE.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-DhBxfc29.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
