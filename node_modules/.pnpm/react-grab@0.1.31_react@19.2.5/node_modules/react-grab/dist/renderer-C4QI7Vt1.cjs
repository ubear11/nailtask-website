 ...
 */
const require_freeze_updates = require('./freeze-updates-D1fkNlIO.cjs');
const require_state = require('./state-D15v4Kng.cjs');
...
var _tmpl$$31 = /* @__PURE__ */ (0, solid_js_web.template)(`<canvas data-react-grab-overlay-canvas style=position:fixed;top:0;left:0;pointer-events:none>`);
const DEFAULT_LAYER_STYLE = {
	borderColor: require_freeze_updates.OVERLAY_BORDER_COLOR_DEFAULT,
	fillColor: require_freeze_updates.OVERLAY_FILL_COLOR_DEFAULT,
	lerpFactor: require_freeze_updates.SELECTION_LERP_FACTOR
};
const LAYER_STYLES = {
	drag: {
		borderColor: require_freeze_updates.OVERLAY_BORDER_COLOR_DRAG,
		fillColor: require_freeze_updates.OVERLAY_FILL_COLOR_DRAG,
		lerpFactor: require_freeze_updates.DRAG_LERP_FACTOR
	},
...
const OverlayCanvas = (props) => {
	...
	const canvasColorSpace = require_freeze_updates.supportsDisplayP3() ? "display-p3" : "srgb";
	...
	const interpolateBounds = (animation, lerpFactor, options) => {
		...
		if (options?.interpolateOpacity) {
			...
			hasOpacityConverged = Math.abs(lerpedOpacity - animation.targetOpacity) < require_freeze_updates.OPACITY_CONVERGENCE_THRESHOLD;
	...
	const runAnimationFrame = () => {
		...
		grabbedAnimations = grabbedAnimations.filter((animation) => {
			...
			if (animation.createdAt) {
				...
				if (elapsed > 1500) {
					animation.opacity = 1 - (elapsed - require_freeze_updates.FEEDBACK_DURATION_MS) / 100;
		...
		compositeAllLayers();
		if (shouldContinueAnimating) animationFrameId = require_freeze_updates.nativeRequestAnimationFrame(runAnimationFrame);
		else animationFrameId = null;
	};
	const scheduleAnimationFrame = () => {
		if (animationFrameId !== null) return;
		animationFrameId = require_freeze_updates.nativeRequestAnimationFrame(runAnimationFrame);
	};
	const handleWindowResize = () => {
		initializeCanvas();
		scheduleAnimationFrame();
	};
	(0, solid_js.createEffect)((0, solid_js.on)(() => [
	...
	(0, solid_js.createEffect)((0, solid_js.on)(() => [props.dragVisible, props.dragBounds], ([isVisible, bounds]) => {
		if (!isVisible || !bounds) {
			dragAnimation = null;
			scheduleAnimationFrame();
			return;
	...
	(0, solid_js.createEffect)((0, solid_js.on)(() => [props.grabbedBoxes, props.labelInstances], ([grabbedBoxes, labelInstances]) => {
	...
	(0, solid_js.onMount)(() => {
		...
		(0, solid_js.onCleanup)(() => {
			...
			if (currentDprMediaQuery) currentDprMediaQuery.removeEventListener("change", handleDevicePixelRatioChange);
			if (animationFrameId !== null) require_freeze_updates.nativeCancelAnimationFrame(animationFrameId);
		});
	});
	return (() => {
		var _el$ = _tmpl$$31();
		var _ref$ = canvasRef;
		typeof _ref$ === "function" ? (0, solid_js_web.use)(_ref$, _el$) : canvasRef = _el$;
		(0, solid_js_web.effect)((_$p) => (0, solid_js_web.setStyleProperty)(_el$, "z-index", String(require_freeze_updates.Z_INDEX_OVERLAY_CANVAS)));
		return _el$;
	})();
};
...
const getArrowSize = (labelWidth) => {
	...
	const scaledSize = labelWidth * require_freeze_updates.ARROW_MAX_LABEL_WIDTH_RATIO;
...
const formatShortcut = (shortcut) => {
	...
	if (require_state.isMac()) return `⌘${shortcut}`;
	return `Ctrl+${shortcut.replace("⇧", "Shift+")}`;
};

//#endregion
//#region src/components/icons/icon-submit.tsx
var _tmpl$$30 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 12 12"fill=none><path d="M6 1L6 11M6 1L2 5M6 1L10 5"stroke=currentColor stroke-width=1.5 stroke-linecap=round stroke-linejoin=round>`);
const IconSubmit = (props) => {
	const size = () => props.size ?? 12;
	return (() => {
		var _el$ = _tmpl$$30();
		(0, solid_js_web.effect)((_p$) => {
			var _v$ = size(), _v$2 = size(), _v$3 = props.class;
			_v$ !== _p$.e && (0, solid_js_web.setAttribute)(_el$, "width", _p$.e = _v$);
			_v$2 !== _p$.t && (0, solid_js_web.setAttribute)(_el$, "height", _p$.t = _v$2);
			_v$3 !== _p$.a && (0, solid_js_web.setAttribute)(_el$, "class", _p$.a = _v$3);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
var _tmpl$$28 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-arrow class="absolute w-0 h-0 z-10">`);
const Arrow = (props) => {
	...
	return (() => {
		...
		(0, solid_js_web.effect)((_p$) => {
			...
			_v$ !== _p$.e && (0, solid_js_web.setStyleProperty)(_el$, "left", _p$.e = _v$);
			_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "top", _p$.t = _v$2);
			_v$3 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$, "bottom", _p$.a = _v$3);
			_v$4 !== _p$.o && (0, solid_js_web.setStyleProperty)(_el$, "transform", _p$.o = _v$4);
			_v$5 !== _p$.i && (0, solid_js_web.setStyleProperty)(_el$, "border-left", _p$.i = _v$5);
			_v$6 !== _p$.n && (0, solid_js_web.setStyleProperty)(_el$, "border-right", _p$.n = _v$6);
			_v$7 !== _p$.s && (0, solid_js_web.setStyleProperty)(_el$, "border-bottom", _p$.s = _v$7);
			_v$8 !== _p$.h && (0, solid_js_web.setStyleProperty)(_el$, "border-top", _p$.h = _v$8);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
var _tmpl$$27 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-linecap=round stroke-linejoin=round stroke-width=2><path d="M12 6H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6"></path><path d="M11 13l9-9"></path><path d="M15 4h5v5">`);
...
var _tmpl$$26 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class=text-black>`), _tmpl$2$12 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class=text-black/50>.`), _tmpl$3$8 = /* @__PURE__ */ (0, solid_js_web.template)(`<div><span class="text-[13px] leading-4 h-fit font-medium overflow-hidden text-ellipsis whitespace-nowrap min-w-0">`);
const TagBadge = (props) => {
	...
	return (() => {
		...
		(0, solid_js_web.addEventListener)(_el$, "click", props.onClick, true);
		_el$.addEventListener("mouseleave", handleMouseLeave);
		_el$.addEventListener("mouseenter", handleMouseEnter);
		(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
			get when() {
			...
			get children() {
				return [(() => {
					var _el$3 = _tmpl$$26();
					(0, solid_js_web.insert)(_el$3, () => props.componentName);
					return _el$3;
				})(), (() => {
					var _el$4 = _tmpl$2$12();
					_el$4.firstChild;
					(0, solid_js_web.insert)(_el$4, () => props.tagName, null);
					return _el$4;
				})()];
			}
		}), null);
		(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
			...
			get children() {
				var _el$6 = _tmpl$$26();
				(0, solid_js_web.insert)(_el$6, () => props.tagName);
				return _el$6;
			}
		}), null);
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.Show, {
			get when() {
				return props.isClickable || props.forceShowIcon;
			},
			get children() {
				return (0, solid_js_web.createComponent)(IconOpen, {
					size: 10,
					get ["class"]() {
		...
		(0, solid_js_web.effect)(() => (0, solid_js_web.className)(_el$, cn("contain-layout flex items-center gap-1 max-w-[280px] overflow-hidden", props.shrink && "shrink-0", props.isClickable && "cursor-pointer")));
		return _el$;
	})();
};
...
var _tmpl$$25 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="[font-synthesis:none] contain-layout shrink-0 flex flex-col items-start px-2 py-1.5 w-auto h-fit self-stretch [border-top-width:0.5px] border-t-solid border-t-[#D9D9D9] antialiased rounded-t-none rounded-b-[6px]">`);
const BottomSection = (props) => (() => {
	var _el$ = _tmpl$$25();
	(0, solid_js_web.insert)(_el$, () => props.children);
	return _el$;
})();
...
const DiscardPrompt = (props) => {
	...
	return (() => {
		...
		(0, solid_js_web.insert)(_el$3, () => props.label ?? "Discard?");
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(BottomSection, { get children() {
			var _el$4 = _tmpl$$23(), _el$5 = _el$4.firstChild, _el$6 = _el$5.nextSibling;
			_el$6.firstChild;
			(0, solid_js_web.addEventListener)(_el$5, "click", props.onCancel, true);
			(0, solid_js_web.addEventListener)(_el$6, "click", props.onConfirm, true);
			(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(IconReturn, {
				size: 10,
...
(0, solid_js_web.delegateEvents)(["pointerdown", "click"]);

//#endregion
//#region src/components/icons/icon-retry.tsx
var _tmpl$$22 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4C7.58 4 4.01 7.58 4.01 12C4.01 16.42 7.58 20 12 20C15.73 20 18.84 17.45 19.73 14H17.65C16.83 16.33 14.61 18 12 18C8.69 18 6 15.31 6 12C6 8.69 8.69 6 12 6C13.66 6 15.14 6.69 16.22 7.78L13 11H20V4L17.65 6.35Z"fill=currentColor>`);
...
const ErrorView = (props) => {
	...
	return (() => {
		...
		_el$.$$click = handleFocus;
		_el$.$$pointerdown = handleFocus;
		(0, solid_js_web.insert)(_el$3, () => props.error);
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.Show, {
			get when() {
				return hasActions();
			},
			get children() {
				return (0, solid_js_web.createComponent)(BottomSection, { get children() {
					var _el$4 = _tmpl$$21(), _el$5 = _el$4.firstChild;
					_el$5.firstChild;
					var _el$7 = _el$5.nextSibling;
					(0, solid_js_web.addEventListener)(_el$5, "click", props.onRetry, true);
					(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(IconRetry, {
						size: 10,
						"class": "text-black/50"
					}), null);
					(0, solid_js_web.addEventListener)(_el$7, "click", props.onAcknowledge, true);
					return _el$4;
				} });
			}
		}), null);
		(0, solid_js_web.effect)((_p$) => {
			...
			_p$.e = (0, solid_js_web.classList)(_el$2, _v$, _p$.e);
			_v$2 !== _p$.t && (0, solid_js_web.setAttribute)(_el$3, "title", _p$.t = _v$2);
			return _p$;
		}, {
			e: void 0,
			t: void 0
...
var _tmpl$$20 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=currentColor><circle cx=5 cy=12 r=2></circle><circle cx=12 cy=12 r=2></circle><circle cx=19 cy=12 r=2>`);
...
var _tmpl$$18 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-ignore-events data-react-grab-more-options class="flex items-center justify-center size-[18px] rounded-sm cursor-pointer bg-transparent hover:bg-black/10 text-black/30 hover:text-black border-none outline-none p-0 shrink-0 press-scale">`), _tmpl$2$9 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-dismiss class="contain-layout shrink-0 flex items-center justify-center gap-1 px-[3px] py-px rounded-sm bg-white [border-width:0.5px] border-solid border-[#B3B3B3] cursor-pointer transition-all hover:bg-[#F5F5F5] press-scale h-[17px]"><span class="text-black text-[13px] leading-3.5 font-sans font-medium">Keep`), _tmpl$3$7 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="contain-layout shrink-0 flex items-center justify-between gap-2 pt-1.5 pb-1 px-2 w-full h-fit"><span class="text-black text-[13px] leading-4 font-sans font-medium h-fit tabular-nums overflow-hidden text-ellipsis whitespace-nowrap min-w-0"></span><div class="contain-layout shrink-0 flex items-center gap-2 h-fit">`), _tmpl$4$5 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="contain-layout shrink-0 flex items-center gap-0.5 py-1.5 px-2 w-full h-fit"><span class="text-black text-[13px] leading-4 font-sans font-medium h-fit tabular-nums overflow-hidden text-ellipsis whitespace-nowrap min-w-0">`), _tmpl$5$4 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-completion>`);
const MoreOptionsButton = (props) => {
	return (() => {
		var _el$ = _tmpl$$18();
		(0, solid_js_web.addEventListener)(_el$, "click", (event) => {
			event.stopImmediatePropagation();
			props.onClick();
		});
		(0, solid_js_web.addEventListener)(_el$, "pointerdown", (event) => {
			event.stopImmediatePropagation();
		});
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(IconEllipsis, { size: 14 }));
		return _el$;
	})();
};
const CompletionView = (props) => {
	...
	const [didCopy, setDidCopy] = (0, solid_js.createSignal)(false);
	const [isFading, setIsFading] = (0, solid_js.createSignal)(false);
	...
	const handleAccept = () => {
		...
		}, require_freeze_updates.FEEDBACK_DURATION_MS - 100);
	};
	const handleKeyDown = (event) => {
		if (!confirmationFocusManager.isActive(instanceId)) return;
		const isEnter = event.code === "Enter";
	...
	return (() => {
		...
		(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
			get when() {
				return (0, solid_js_web.memo)(() => !!!didCopy())() && props.onDismiss;
			},
			get children() {
				var _el$3 = _tmpl$3$7(), _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling;
				(0, solid_js_web.insert)(_el$4, displayStatusText);
				(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
						return props.onShowContextMenu;
					},
					get children() {
						return (0, solid_js_web.createComponent)(MoreOptionsButton, { onClick: handleShowContextMenu });
					}
				}), null);
				(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
					...
					get children() {
						...
						(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(solid_js.Show, {
							get when() {
								return !didCopy();
							},
							get children() {
								return (0, solid_js_web.createComponent)(IconReturn, {
									size: 10,
									"class": "text-black/50"
								});
							}
						}), null);
						(0, solid_js_web.effect)(() => _el$6.disabled = didCopy());
						return _el$6;
					}
				}), null);
				return _el$3;
		...
		(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
			...
			get children() {
				...
				(0, solid_js_web.insert)(_el$8, (0, solid_js_web.createComponent)(IconCheck, {
					size: 14,
					"class": "text-black/85 shrink-0 animate-success-pop"
				}), _el$9);
				(0, solid_js_web.insert)(_el$9, displayStatusText);
				(0, solid_js_web.insert)(_el$8, (0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
						return props.onShowContextMenu;
					},
					get children() {
		...
		(0, solid_js_web.effect)((_p$) => {
			...
			_v$ !== _p$.e && (0, solid_js_web.className)(_el$2, _p$.e = _v$);
			_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$2, "opacity", _p$.t = _v$2);
			return _p$;
		}, {
			e: void 0,
			t: void 0
...
const ArrowNavigationMenu = (props) => {
	...
	return (0, solid_js_web.createComponent)(BottomSection, { get children() {
		...
		(0, solid_js_web.use)((element) => {
			menuItemsRef = element;
			highlightContainerRef(element);
		}, _el$);
		(0, solid_js_web.use)(highlightRef, _el$2);
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.For, {
			get each() {
				return props.items;
			},
			children: (item, itemIndex) => (() => {
				...
				(0, solid_js_web.insert)(_el$4, (0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
						return item.componentName;
					},
					get children() {
						return [(0, solid_js_web.memo)(() => item.componentName), _tmpl$2$8()];
					}
				}), null);
				(0, solid_js_web.insert)(_el$4, () => item.tagName, null);
				(0, solid_js_web.effect)((_p$) => {
					var _v$ = item.tagName, _v$2 = itemIndex(), _v$3 = !!(itemIndex() === props.activeIndex), _v$4 = !!(itemIndex() !== props.activeIndex);
					_v$ !== _p$.e && (0, solid_js_web.setAttribute)(_el$3, "data-react-grab-arrow-nav-item", _p$.e = _v$);
					_v$2 !== _p$.t && (0, solid_js_web.setAttribute)(_el$3, "data-react-grab-arrow-nav-index", _p$.t = _v$2);
...
var _tmpl$$16 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="flex flex-col gap-1 min-w-0"><div class="flex items-center gap-2 min-w-0"><div class="flex items-end gap-px flex-1 min-w-0 rounded-[3px] bg-black/5 px-0.5 overflow-hidden"style=height:20px></div></div><span class="text-[11px] leading-3 text-black/40 tabular-nums"> render<!> · `), _tmpl$2$7 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="shrink-0 rounded-t-[1px] bg-current text-black/30"style=width:2px>`);
const TIMELINE_HEIGHT_PX = 20;
...
const RenderTimelineBar = (props) => {
	const maxDuration = () => Math.max(...props.timeline.commits.map((commit) => commit.duration), .1);
	const totalDuration = () => props.timeline.commits.reduce((sum, commit) => sum + commit.duration, 0);
	return (() => {
		var _el$ = _tmpl$$16(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$2.nextSibling, _el$5 = _el$4.firstChild, _el$7 = _el$5.nextSibling;
		_el$7.nextSibling;
		(0, solid_js_web.insert)(_el$3, (0, solid_js_web.createComponent)(solid_js.For, {
			get each() {
			...
			children: (commit) => {
				const barHeight = () => {
					...
					return Math.max(ratio * (TIMELINE_HEIGHT_PX - 2), MIN_BAR_HEIGHT_PX);
				};
				return (() => {
					var _el$8 = _tmpl$2$7();
					(0, solid_js_web.effect)((_$p) => (0, solid_js_web.setStyleProperty)(_el$8, "height", `${barHeight()}px`));
					return _el$8;
				})();
			}
		}));
		(0, solid_js_web.insert)(_el$4, () => props.timeline.totalRenderCount, _el$5);
		(0, solid_js_web.insert)(_el$4, () => props.timeline.totalRenderCount !== 1 ? "s" : "", _el$7);
		(0, solid_js_web.insert)(_el$4, () => formatDuration(totalDuration()), null);
		return _el$;
	})();
};
...
var _tmpl$$15 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="flex items-center justify-between gap-3 min-w-0"><span class="text-[12px] leading-4 text-black/50 shrink-0"></span><span class="text-[12px] leading-4 text-black font-medium break-all min-w-0 text-right">`), _tmpl$2$6 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="mt-0.5 pt-0.5 [border-top-width:0.5px] border-t-solid border-t-[#D9D9D9]">`), _tmpl$3$5 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class="text-[12px] leading-4 text-black/40 break-all min-w-0">`), _tmpl$4$4 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class="text-[12px] leading-4 text-black/40">`), _tmpl$5$3 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class="text-[12px] leading-4 text-[#8B2BB9]/70 font-mono break-all min-w-0 line-clamp-3">`), _tmpl$6$2 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="flex flex-col w-full max-w-[280px] gap-0.5 cursor-text select-text">`);
const PropertyRow = (props) => (() => {
	var _el$ = _tmpl$$15(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling;
	(0, solid_js_web.insert)(_el$2, () => props.label);
	(0, solid_js_web.insert)(_el$3, () => props.value || "—");
	return _el$;
})();
const SectionDivider = () => _tmpl$2$6();
const ElementPropertiesPanel = (props) => (0, solid_js_web.createComponent)(BottomSection, { get children() {
	var _el$5 = _tmpl$6$2();
	_el$5.$$pointerdown = (event) => event.stopPropagation();
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(PropertyRow, {
		label: "Size",
		get value() {
			return `${Math.round(props.state.width)} × ${Math.round(props.state.height)}`;
		}
	}), null);
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.For, {
		get each() {
			return props.state.reactProps;
		},
		children: (row) => (0, solid_js_web.createComponent)(PropertyRow, {
			get label() {
				return row.label;
			},
			get value() {
	...
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			return [(0, solid_js_web.createComponent)(SectionDivider, {}), (0, solid_js_web.createComponent)(solid_js.For, {
				get each() {
	...
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		get when() {
			return props.state.renderedBy || props.state.source;
		},
		get children() {
			return [
				(0, solid_js_web.createComponent)(SectionDivider, {}),
				(0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
						return props.state.renderedBy;
					},
					get children() {
						var _el$6 = _tmpl$3$5();
						(0, solid_js_web.insert)(_el$6, () => props.state.renderedBy);
						return _el$6;
					}
				}),
				(0, solid_js_web.createComponent)(solid_js.Show, {
					...
					get children() {
						var _el$7 = _tmpl$4$4();
						(0, solid_js_web.insert)(_el$7, () => props.state.source);
						return _el$7;
					}
				})
			];
	...
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		get when() {
			return props.state.className;
		},
		get children() {
			return [(0, solid_js_web.createComponent)(SectionDivider, {}), (() => {
				var _el$8 = _tmpl$5$3();
				(0, solid_js_web.insert)(_el$8, () => props.state.className);
				return _el$8;
			})()];
		}
	}), null);
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		get when() {
			return (0, solid_js_web.memo)(() => !!props.state.timeline)() && props.state.timeline.totalRenderCount > 0;
		},
		get children() {
			return [(0, solid_js_web.createComponent)(SectionDivider, {}), (0, solid_js_web.createComponent)(RenderTimelineBar, { get timeline() {
...
(0, solid_js_web.delegateEvents)(["pointerdown"]);

//#endregion
//#region src/components/selection-label/index.tsx
var _tmpl$$14 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="contain-layout shrink-0 flex flex-col justify-center items-start w-fit h-fit max-w-[280px]"><div class="contain-layout shrink-0 flex items-center gap-1 py-1.5 px-2 w-full h-fit"><span class="shimmer-text text-[13px] leading-4 font-sans font-medium h-fit tabular-nums overflow-hidden text-ellipsis whitespace-nowrap">`), _tmpl$2$5 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="flex flex-col w-[calc(100%+16px)] -mx-2 -my-1.5">`), _tmpl$3$4 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="contain-layout shrink-0 flex flex-col items-start w-fit h-fit"><div class="contain-layout shrink-0 flex items-center gap-1 w-fit h-fit px-2">`), _tmpl$4$3 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-submit class="contain-layout shrink-0 flex items-center justify-center size-4 rounded-full bg-black cursor-pointer ml-1 interactive-scale">`), _tmpl$5$2 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="shrink-0 flex justify-between items-end w-full min-h-4"><textarea data-react-grab-ignore-events data-react-grab-input class="text-black text-[13px] leading-4 font-medium bg-transparent border-none outline-none resize-none flex-1 p-0 m-0 wrap-break-word overflow-y-auto"placeholder="Add context"rows=1 style=field-sizing:content;min-height:16px;scrollbar-width:none>`), _tmpl$6$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="contain-layout shrink-0 flex flex-col justify-center items-start w-fit h-fit min-w-[150px] max-w-[280px]"><div class="contain-layout shrink-0 flex items-center gap-1 pt-1.5 pb-1 w-fit h-fit px-2 max-w-full">`), _tmpl$7$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-ignore-events data-react-grab-selection-label><div>`), _tmpl$8$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class="text-[11px] font-sans text-black/50 ml-4">`), _tmpl$9$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="contain-layout flex items-center justify-between w-full px-2 py-1 transition-colors"><span class="text-[13px] leading-4 font-sans font-medium text-black">`);
const DEFAULT_OFFSCREEN_POSITION = {
	left: require_freeze_updates.SELECTION_LABEL_OFFSCREEN_PX,
	top: require_freeze_updates.SELECTION_LABEL_OFFSCREEN_PX,
	arrowLeftPercent: 50,
	arrowLeftOffset: 0,
	edgeOffsetX: 0
};
const SelectionLabel = (props) => {
	...
	const [measuredWidth, setMeasuredWidth] = (0, solid_js.createSignal)(0);
	const [measuredHeight, setMeasuredHeight] = (0, solid_js.createSignal)(0);
	const [panelWidth, setPanelWidth] = (0, solid_js.createSignal)(0);
	const [viewportVersion, setViewportVersion] = (0, solid_js.createSignal)(0);
	const [isInternalFading, setIsInternalFading] = (0, solid_js.createSignal)(false);
	const [isShaking, setIsShaking] = (0, solid_js.createSignal)(false);
	...
	const positionComputation = (0, solid_js.createMemo)((previousResult) => {
		viewportVersion();
	...
	(0, solid_js.createEffect)((0, solid_js.on)(() => props.selectionLabelShakeCount, () => setIsShaking(true), { defer: true }));
	const handleKeyDown = (event) => {
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		get when() {
			return (0, solid_js_web.memo)(() => props.visible !== false)() && (props.selectionBounds || shouldPersistDuringFade());
		},
		get children() {
			...
			typeof _ref$ === "function" ? (0, solid_js_web.use)(_ref$, _el$) : containerRef = _el$;
			(0, solid_js_web.setStyleProperty)(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.Show, {
				get when() {
					return !props.hideArrow;
				},
				get children() {
					return (0, solid_js_web.createComponent)(Arrow, {
						get position() {
			...
			(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.Show, {
				get when() {
					return (0, solid_js_web.memo)(() => !!isCompletedStatus())() && !props.error;
				},
				get children() {
					return (0, solid_js_web.createComponent)(CompletionView, {
						get statusText() {
			...
			var _ref$2 = panelRef;
			typeof _ref$2 === "function" ? (0, solid_js_web.use)(_ref$2, _el$2) : panelRef = _el$2;
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
				get when() {
				...
				get children() {
					...
					(0, solid_js_web.insert)(_el$4, (0, solid_js_web.createComponent)(IconLoader, {
						size: 13,
						"class": "text-[#71717a] shrink-0"
					}), _el$5);
					(0, solid_js_web.insert)(_el$5, () => props.statusText ?? "Grabbing…");
					return _el$3;
				}
			}), null);
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
				get when() {
					return (0, solid_js_web.memo)(() => !!canInteract())() && !props.isPromptMode;
				},
				get children() {
					var _el$6 = _tmpl$3$4(), _el$7 = _el$6.firstChild;
					(0, solid_js_web.insert)(_el$7, (0, solid_js_web.createComponent)(TagBadge, {
						get tagName() {
						...
						shrink: true,
						get forceShowIcon() {
							return (0, solid_js_web.memo)(() => !!(isArrowNavigationVisible() || isInspectNavigationVisible()))() ? Boolean(props.filePath && props.onOpen) : Boolean(props.isContextMenuOpen);
						}
					}));
					(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(solid_js.Show, {
						get when() {
						...
						get children() {
							return (0, solid_js_web.createComponent)(ArrowNavigationMenu, {
								get items() {
					...
					(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(solid_js.Show, {
						get when() {
							return (0, solid_js_web.memo)(() => !!(!isArrowNavigationVisible() && isInspectNavigationVisible()))() && props.inspectPropertiesState;
						},
						children: (state) => (0, solid_js_web.createComponent)(ElementPropertiesPanel, { get state() {
							return state();
						} })
					}), null);
					(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(solid_js.Show, {
						get when() {
							return (0, solid_js_web.memo)(() => !!(!isArrowNavigationVisible() && !isInspectNavigationVisible()))() && Boolean(props.actionCycleState?.isVisible);
						},
						get children() {
							return (0, solid_js_web.createComponent)(BottomSection, { get children() {
								var _el$8 = _tmpl$2$5();
								(0, solid_js_web.insert)(_el$8, (0, solid_js_web.createComponent)(solid_js.For, {
									get each() {
										return props.actionCycleState?.items ?? [];
									},
									children: (item, itemIndex) => (() => {
										var _el$12 = _tmpl$9$1(), _el$13 = _el$12.firstChild;
										(0, solid_js_web.insert)(_el$13, () => item.label);
										(0, solid_js_web.insert)(_el$12, (0, solid_js_web.createComponent)(solid_js.Show, {
											get when() {
												return item.shortcut;
											},
											get children() {
												var _el$14 = _tmpl$8$1();
												(0, solid_js_web.insert)(_el$14, () => formatShortcut(item.shortcut));
												return _el$14;
											}
										}), null);
										(0, solid_js_web.effect)((_p$) => {
											...
											_v$1 !== _p$.e && (0, solid_js_web.setAttribute)(_el$12, "data-react-grab-action-cycle-item", _p$.e = _v$1);
					...
					(0, solid_js_web.effect)((_p$) => {
						...
						_p$.t = (0, solid_js_web.classList)(_el$7, _v$2, _p$.t);
						return _p$;
					}, {
						e: void 0,
						t: void 0
			...
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
				get when() {
					return (0, solid_js_web.memo)(() => !!(canInteract() && props.isPromptMode))() && !props.isPendingDismiss;
				},
				get children() {
					var _el$9 = _tmpl$6$1(), _el$0 = _el$9.firstChild;
					(0, solid_js_web.insert)(_el$0, (0, solid_js_web.createComponent)(TagBadge, {
						get tagName() {
							return tagDisplayResult().tagName;
						},
						get componentName() {
					...
					(0, solid_js_web.insert)(_el$9, (0, solid_js_web.createComponent)(BottomSection, { get children() {
						...
						(0, solid_js_web.setStyleProperty)(_el$10, "max-height", `${95}px`);
						(0, solid_js_web.insert)(_el$1, (0, solid_js_web.createComponent)(solid_js.Show, {
							get when() {
							...
							get children() {
								...
								(0, solid_js_web.insert)(_el$11, (0, solid_js_web.createComponent)(IconSubmit, {
									size: 10,
									"class": "text-white"
								}));
								return _el$11;
						...
						(0, solid_js_web.effect)(() => _el$10.readOnly = !props.onSubmit);
						(0, solid_js_web.effect)(() => _el$10.value = props.inputValue ?? "");
						return _el$1;
					} }), null);
					return _el$9;
				}
			...
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
				...
				get children() {
					return (0, solid_js_web.createComponent)(DiscardPrompt, {
						get onConfirm() {
			...
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
				...
				get children() {
					return (0, solid_js_web.createComponent)(ErrorView, {
						get error() {
							return props.error;
						},
						get onAcknowledge() {
			...
			(0, solid_js_web.effect)((_p$) => {
				...
				_v$3 !== _p$.e && (0, solid_js_web.className)(_el$, _p$.e = _v$3);
				_v$4 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "top", _p$.t = _v$4);
				_v$5 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$, "left", _p$.a = _v$5);
				_v$6 !== _p$.o && (0, solid_js_web.setStyleProperty)(_el$, "transform", _p$.o = _v$6);
				_v$7 !== _p$.i && (0, solid_js_web.setStyleProperty)(_el$, "pointer-events", _p$.i = _v$7);
				_v$8 !== _p$.n && (0, solid_js_web.setStyleProperty)(_el$, "opacity", _p$.n = _v$8);
				_v$9 !== _p$.s && (0, solid_js_web.className)(_el$2, _p$.s = _v$9);
				_v$0 !== _p$.h && (0, solid_js_web.setStyleProperty)(_el$2, "display", _p$.h = _v$0);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
var _tmpl$$10 = /* @__PURE__ */ (0, solid_js_web.template)(`<div>`);
let lastCloseTimestamp = 0;
const wasTooltipRecentlyVisible = () => {
	return Date.now() - lastCloseTimestamp < 100;
};
const Tooltip = (props) => {
	const [delayedVisible, setDelayedVisible] = (0, solid_js.createSignal)(false);
	const [shouldAnimate, setShouldAnimate] = (0, solid_js.createSignal)(true);
	let delayTimeoutId;
	(0, solid_js.createEffect)((0, solid_js.on)(() => props.visible, (isVisible) => {
	...
	const positionStyle = () => {
		if (props.position === "top" || props.position === "bottom") return {
			left: "50%",
			translate: "-50%",
			"z-index": `${require_freeze_updates.Z_INDEX_OVERLAY}`
		};
		return {
			top: "50%",
			translate: "0 -50%",
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			...
			(0, solid_js_web.insert)(_el$, () => props.children);
			(0, solid_js_web.effect)((_p$) => {
				var _v$ = cn(require_freeze_updates.TOOLTIP_BASE_CLASS, "bg-white", props.position === "top" && "bottom-full mb-2.5", props.position === "bottom" && "top-full mt-2.5", props.position === "left" && "right-full mr-2.5", props.position === "right" && "left-full ml-2.5", shouldAnimate() && "animate-tooltip-fade-in"), _v$2 = positionStyle();
				_v$ !== _p$.e && (0, solid_js_web.className)(_el$, _p$.e = _v$);
				_p$.t = (0, solid_js_web.style)(_el$, _v$2, _p$.t);
				return _p$;
			}, {
				e: void 0,
				t: void 0
...
var _tmpl$$9 = /* @__PURE__ */ (0, solid_js_web.template)(`<kbd class="inline-flex items-center justify-center px-[3px] h-3.5 rounded-sm [border-width:0.5px] border-solid border-[#B3B3B3] text-black/70 text-[10px] font-medium leading-none">`);
const Kbd = (props) => (() => {
	var _el$ = _tmpl$$9();
	(0, solid_js_web.insert)(_el$, () => props.children);
	return _el$;
...
var _tmpl$$8 = /* @__PURE__ */ (0, solid_js_web.template)(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2.5 stroke-linecap=round stroke-linejoin=round><path d="m18 15-6-6-6 6">`);
...
var _tmpl$$7 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-ignore-events data-react-grab-toolbar-collapse class="contain-layout shrink-0 flex items-center justify-center cursor-pointer interactive-scale">`), _tmpl$2$4 = /* @__PURE__ */ (0, solid_js_web.template)(`<div><div><div><div><div><div></div></div><div><div></div></div><div><div></div></div></div><div class="relative shrink-0 overflow-visible">`);
const ToolbarContent = (props) => {
	...
	const defaultCollapseButton = () => (() => {
		var _el$ = _tmpl$$7();
		(0, solid_js_web.addEventListener)(_el$, "click", props.onCollapseClick, true);
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(IconChevron, {
			size: 14,
			get ["class"]() {
				return cn("text-[#B3B3B3] transition-transform duration-150", chevronRotation());
			}
		}));
		(0, solid_js_web.effect)(() => (0, solid_js_web.setAttribute)(_el$, "aria-label", props.isCollapsed ? "Expand toolbar" : "Collapse toolbar"));
		return _el$;
	})();
	return (() => {
		...
		(0, solid_js_web.addEventListener)(_el$2, "click", props.onPanelClick, true);
		(0, solid_js_web.addEventListener)(_el$2, "animationend", props.onAnimationEnd);
		(0, solid_js_web.use)((element) => props.onExpandableButtonsRef?.(element), _el$5);
		(0, solid_js_web.insert)(_el$7, () => props.selectButton);
		(0, solid_js_web.insert)(_el$9, () => props.commentsButton);
		(0, solid_js_web.insert)(_el$1, () => props.copyAllButton);
		(0, solid_js_web.insert)(_el$10, () => props.toggleButton);
		(0, solid_js_web.insert)(_el$2, () => props.collapseButton ?? defaultCollapseButton(), null);
		(0, solid_js_web.effect)((_p$) => {
			...
			_v$ !== _p$.e && (0, solid_js_web.className)(_el$2, _p$.e = _v$);
			_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$2, "transform-origin", _p$.t = _v$2);
			_v$3 !== _p$.a && (0, solid_js_web.className)(_el$3, _p$.a = _v$3);
			_v$4 !== _p$.o && (0, solid_js_web.className)(_el$4, _p$.o = _v$4);
			_v$5 !== _p$.i && (0, solid_js_web.className)(_el$5, _p$.i = _v$5);
			_v$6 !== _p$.n && (0, solid_js_web.className)(_el$6, _p$.n = _v$6);
			_v$7 !== _p$.s && (0, solid_js_web.className)(_el$7, _p$.s = _v$7);
			_v$8 !== _p$.h && (0, solid_js_web.className)(_el$8, _p$.h = _v$8);
			_v$9 !== _p$.r && (0, solid_js_web.className)(_el$9, _p$.r = _v$9);
			_v$0 !== _p$.d && (0, solid_js_web.className)(_el$0, _p$.d = _v$0);
			_v$1 !== _p$.l && (0, solid_js_web.className)(_el$1, _p$.l = _v$1);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
const createToolbarDrag = (config) => {
	const [isDragging, setIsDragging] = (0, solid_js.createSignal)(false);
	const [isSnapping, setIsSnapping] = (0, solid_js.createSignal)(false);
	const [hasDragMoved, setHasDragMoved] = (0, solid_js.createSignal)(false);
	const [velocity, setVelocity] = (0, solid_js.createSignal)({
		x: 0,
		y: 0
	});
	let dragOffset = {
	...
	const handleWindowPointerUp = () => {
		...
		const snap = require_state.getSnapPosition(rect.left, rect.top, rect.width, rect.height, currentVelocity.x, currentVelocity.y);
		const ratio = require_state.getRatioFromPosition(snap.edge, snap.x, snap.y, rect.width, rect.height);
		config.onSnapEdgeChange(snap.edge, ratio);
		setIsSnapping(true);
		require_freeze_updates.nativeRequestAnimationFrame(() => {
			...
			require_freeze_updates.nativeRequestAnimationFrame(() => {
				const snappedPosition = require_state.getPositionFromEdgeAndRatio(snap.edge, ratio, updatedDimensions.width, updatedDimensions.height);
...
var _tmpl$$6 = /* @__PURE__ */ (0, solid_js_web.template)(`<span>Click or<!>to capture`), _tmpl$2$3 = /* @__PURE__ */ (0, solid_js_web.template)(`<span>to fine-tune target`), _tmpl$3$3 = /* @__PURE__ */ (0, solid_js_web.template)(`<span>to cancel`), _tmpl$4$2 = /* @__PURE__ */ (0, solid_js_web.template)(`<div>`), _tmpl$5$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<div>Enable to continue`), _tmpl$6 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-ignore-events data-react-grab-toolbar>`), _tmpl$7 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-ignore-events data-react-grab-toolbar-toggle>`), _tmpl$8 = /* @__PURE__ */ (0, solid_js_web.template)(`<span data-react-grab-unread-indicator class="absolute -top-1 -right-1 min-w-2.5 h-2.5 px-0.5 flex items-center justify-center rounded-full bg-black text-white text-[8px] font-semibold leading-none">`), _tmpl$9 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-ignore-events data-react-grab-toolbar-comments aria-haspopup=menu><span class="inline-flex relative">`), _tmpl$0 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-ignore-events data-react-grab-toolbar-copy-all aria-label="Copy all comments">`), _tmpl$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-ignore-events data-react-grab-toolbar-enabled><div><div>`);
const Toolbar = (props) => {
	let containerRef;
	...
	const savedState = require_state.loadToolbarState();
	const [isVisible, setIsVisible] = (0, solid_js.createSignal)(false);
	const [isCollapsed, setIsCollapsed] = (0, solid_js.createSignal)(false);
	const [isResizing, setIsResizing] = (0, solid_js.createSignal)(false);
	const [snapEdge, setSnapEdge] = (0, solid_js.createSignal)(savedState?.edge ?? "bottom");
	const [positionRatio, setPositionRatio] = (0, solid_js.createSignal)(savedState?.ratio ?? .5);
	const [position, setPosition] = (0, solid_js.createSignal)({
		x: 0,
		y: 0
	});
	const [isShaking, setIsShaking] = (0, solid_js.createSignal)(false);
	const [isCollapseAnimating, setIsCollapseAnimating] = (0, solid_js.createSignal)(false);
	const [isSelectTooltipVisible, setIsSelectTooltipVisible] = (0, solid_js.createSignal)(false);
	const [isToggleTooltipVisible, setIsToggleTooltipVisible] = (0, solid_js.createSignal)(false);
	const [isShakeTooltipVisible, setIsShakeTooltipVisible] = (0, solid_js.createSignal)(false);
	const [isToggleAnimating, setIsToggleAnimating] = (0, solid_js.createSignal)(false);
	const [isRapidRetoggle, setIsRapidRetoggle] = (0, solid_js.createSignal)(false);
	const [isCommentsTooltipVisible, setIsCommentsTooltipVisible] = (0, solid_js.createSignal)(false);
	const [isCopyAllTooltipVisible, setIsCopyAllTooltipVisible] = (0, solid_js.createSignal)(false);
	let clockFlashRef;
	const [selectionHintIndex, setSelectionHintIndex] = (0, solid_js.createSignal)(0);
	const [hasHintCycled, setHasHintCycled] = (0, solid_js.createSignal)(false);
	...
	(0, solid_js.createEffect)((0, solid_js.on)(() => [props.isActive, hasLearnedSelectionHints()], ([isActive, hasLearned]) => {
		...
		}, require_freeze_updates.SELECTION_HINT_CYCLE_INTERVAL_MS);
		(0, solid_js.onCleanup)(() => clearInterval(intervalId));
	}, { defer: true }));
	...
	const createFreezeHandlers = (setTooltipVisible, options) => ({
		onMouseEnter: () => {
			...
			if (options?.shouldFreezeInteractions !== false && !unfreezeUpdatesCallback) {
				unfreezeUpdatesCallback = require_freeze_updates.freezeUpdates();
				require_freeze_updates.freezeGlobalAnimations();
				require_freeze_updates.freezePseudoStates();
			}
	...
	(0, solid_js.createEffect)((0, solid_js.on)(() => props.shakeCount, (count) => {
		if (count && !props.enabled) {
			...
			}, require_freeze_updates.TOOLBAR_SHAKE_TOOLTIP_DURATION_MS);
			(0, solid_js.onCleanup)(() => {
				clearShakeTooltipTimeout();
			});
		}
	}));
	(0, solid_js.createEffect)((0, solid_js.on)(() => props.enabled, (enabled) => {
		if (enabled && isShakeTooltipVisible()) {
			setIsShakeTooltipVisible(false);
			clearShakeTooltipTimeout();
		}
	}));
	(0, solid_js.createEffect)((0, solid_js.on)(() => [props.isActive, props.isContextMenuOpen], ([isActive, isContextMenuOpen]) => {
	...
	const reclampToolbarToViewport = () => {
		...
		const viewport = require_state.getVisualViewport();
		const edge = snapEdge();
		...
		if (edge === "top" || edge === "bottom") {
			...
			clampedX = require_state.clampToRange(currentPos.x, minX, maxX);
			...
			clampedY = require_state.clampToRange(currentPos.y, minY, maxY);
			clampedX = edge === "left" ? viewport.offsetLeft + 16 : viewport.offsetLeft + viewport.width - rect.width - 16;
		}
		setPositionRatio(require_state.getRatioFromPosition(edge, clampedX, clampedY, rect.width, rect.height));
	...
	(0, solid_js.createEffect)((0, solid_js.on)(() => props.clockFlashTrigger ?? 0, () => {
	...
	(0, solid_js.createEffect)((0, solid_js.on)(() => props.commentItemCount ?? 0, () => {
	...
	const [collapsedDimensions, setCollapsedDimensions] = (0, solid_js.createSignal)({
		width: 14,
		height: 14
	});
	const getExpandedFromCollapsed = (collapsedPosition, edge) => {
		...
		return require_state.calculateExpandedPositionFromCollapsed(collapsedPosition, edge, expandedDimensions, actualCollapsedWidth, actualCollapsedHeight);
	};
	const recalculatePosition = () => {
		setPosition(require_state.getPositionFromEdgeAndRatio(snapEdge(), positionRatio(), expandedDimensions.width, expandedDimensions.height));
	};
		...
		if (shouldCompensatePosition) {
			...
			const computeClampedPosition = (expandDimension) => {
				...
				if (isVerticalEdge) {
					...
					return {
						...
						y: require_state.clampToRange(targetAxisPosition, clampMin, clampMax)
					};
				}
				return {
					x: require_state.clampToRange(targetAxisPosition, viewport.offsetLeft + 16, viewport.offsetLeft + viewport.width - expandedDimensions.width - 16),
					y: preTogglePosition.y
				};
			};
			if (toggleAnimationRafId !== void 0) require_freeze_updates.nativeCancelAnimationFrame(toggleAnimationRafId);
			if (isRapidRetoggle()) {
				...
				const syncPositionWithGrid = () => {
					...
					toggleAnimationRafId = require_freeze_updates.nativeRequestAnimationFrame(syncPositionWithGrid);
				};
				toggleAnimationRafId = require_freeze_updates.nativeRequestAnimationFrame(syncPositionWithGrid);
			}
			...
			toggleAnimationTimeout = setTimeout(() => {
				if (toggleAnimationRafId !== void 0) {
					require_freeze_updates.nativeCancelAnimationFrame(toggleAnimationRafId);
					toggleAnimationRafId = void 0;
				}
				setPosition(computeClampedPosition(isCurrentlyEnabled ? 0 : expandableDimension));
				setIsToggleAnimating(false);
				setIsRapidRetoggle(false);
				const newRatio = require_state.getRatioFromPosition(edge, position().x, position().y, expandedDimensions.width, expandedDimensions.height);
				setPositionRatio(newRatio);
				saveAndNotify({
					edge,
					ratio: newRatio,
	...
	const computeCollapsedPosition = () => require_state.getCollapsedPosition(snapEdge(), position(), expandedDimensions, collapsedDimensions());
	let resizeTimeout;
	...
	const handleResize = () => {
		...
		resizeTimeout = setTimeout(() => {
			setIsResizing(false);
			const newRatio = require_state.getRatioFromPosition(snapEdge(), position().x, position().y, expandedDimensions.width, expandedDimensions.height);
			setPositionRatio(newRatio);
			saveAndNotify({
				edge: snapEdge(),
				ratio: newRatio,
	...
	const saveAndNotify = (state) => {
		require_state.saveToolbarState(state);
	...
	(0, solid_js.onMount)(() => {
		...
		if (savedState) {
			...
			setPosition(require_state.getPositionFromEdgeAndRatio(savedState.edge, savedState.ratio, expandedDimensions.width, expandedDimensions.height));
		} else if (rect) {
			expandedDimensions = {
				width: rect.width,
				height: rect.height
			...
			setPositionRatio(require_freeze_updates.TOOLBAR_DEFAULT_POSITION_RATIO);
		} else setPosition(require_state.getPositionFromEdgeAndRatio("bottom", require_freeze_updates.TOOLBAR_DEFAULT_POSITION_RATIO, expandedDimensions.width, expandedDimensions.height));
		if (props.enabled) measureExpandableDimension();
		if (props.onSubscribeToStateChanges) (0, solid_js.onCleanup)(props.onSubscribeToStateChanges((state) => {
			...
			if (didCollapsedChange && !state.collapsed) {
				...
				setIsCollapsed(state.collapsed);
				setPosition(require_state.getPositionFromEdgeAndRatio(state.edge, state.ratio, expandedDimensions.width, expandedDimensions.height));
	...
	return (() => {
		...
		(0, solid_js_web.addEventListener)(_el$, "mousedown", stopEventPropagation);
		(0, solid_js_web.addEventListener)(_el$, "pointerdown", (event) => {
		...
		var _ref$ = containerRef;
		typeof _ref$ === "function" ? (0, solid_js_web.use)(_ref$, _el$) : containerRef = _el$;
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(ToolbarContent, {
			get isActive() {
			...
			get selectButton() {
				return [(() => {
					var _el$10 = _tmpl$7();
					(0, solid_js_web.addEventListener)(_el$10, "contextmenu", (event) => {
						event.preventDefault();
						event.stopPropagation();
					...
					(0, solid_js_web.spread)(_el$10, (0, solid_js_web.mergeProps)({
						get ["aria-label"]() {
					...
					(0, solid_js_web.insert)(_el$10, (0, solid_js_web.createComponent)(IconSelect, {
						size: 14,
						get ["class"]() {
					...
					return _el$10;
				})(), (0, solid_js_web.createComponent)(Tooltip, {
					get visible() {
						return (0, solid_js_web.memo)(() => !!isSelectTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
					get children() {
						return ["Select element ", (0, solid_js_web.createComponent)(Kbd, { get children() {
			...
			get commentsButton() {
				return [(() => {
					...
					(0, solid_js_web.spread)(_el$11, (0, solid_js_web.mergeProps)({
						get ["aria-label"]() {
					...
					typeof _ref$2 === "function" ? (0, solid_js_web.use)(_ref$2, _el$12) : clockFlashRef = _el$12;
					(0, solid_js_web.insert)(_el$12, (0, solid_js_web.createComponent)(IconComment, {
						size: 14,
						get ["class"]() {
					...
					(0, solid_js_web.insert)(_el$12, (0, solid_js_web.createComponent)(solid_js.Show, {
						...
						get children() {
							var _el$13 = _tmpl$8();
							(0, solid_js_web.insert)(_el$13, () => props.commentItemCount);
							return _el$13;
						}
					}), null);
					return _el$11;
					...
					get visible() {
						return (0, solid_js_web.memo)(() => !!isCommentsTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
			...
			get copyAllButton() {
				return [(() => {
					...
					(0, solid_js_web.spread)(_el$14, (0, solid_js_web.mergeProps)({ get ["class"]() {
						return cn("contain-layout flex items-center justify-center cursor-pointer interactive-scale touch-hitbox", buttonSpacingClass(), hitboxConstraintClass());
					...
					(0, solid_js_web.insert)(_el$14, (0, solid_js_web.createComponent)(IconCopy, {
						size: 14,
					...
					get visible() {
						return (0, solid_js_web.memo)(() => !!isCopyAllTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
			...
			get toggleButton() {
				return [(() => {
					...
					(0, solid_js_web.effect)((_p$) => {
						...
						_v$9 !== _p$.e && (0, solid_js_web.setAttribute)(_el$15, "aria-label", _p$.e = _v$9);
						_v$0 !== _p$.t && (0, solid_js_web.setAttribute)(_el$15, "aria-pressed", _p$.t = _v$0);
						_v$1 !== _p$.a && (0, solid_js_web.className)(_el$15, _p$.a = _v$1);
						_v$10 !== _p$.o && (0, solid_js_web.className)(_el$16, _p$.o = _v$10);
						_v$11 !== _p$.i && (0, solid_js_web.className)(_el$17, _p$.i = _v$11);
						return _p$;
					}, {
						e: void 0,
						t: void 0,
					...
					get visible() {
						return (0, solid_js_web.memo)(() => !!isToggleTooltipVisible())() && isTooltipAllowed();
					},
					get position() {
						return tooltipPosition();
					},
		...
		(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(solid_js.Show, {
			...
			get children() {
				return [(0, solid_js_web.createComponent)(solid_js.Show, {
					get when() {
						return (0, solid_js_web.memo)(() => !!props.isActive)() && !hasLearnedSelectionHints();
					},
					get children() {
						var _el$2 = _tmpl$4$2();
						(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
							...
							get children() {
								...
								_el$6.nextSibling;
								(0, solid_js_web.insert)(_el$3, (0, solid_js_web.createComponent)(Kbd, { children: "↵" }), _el$6);
								(0, solid_js_web.effect)(() => (0, solid_js_web.className)(_el$3, cn("flex items-center gap-1", hasHintCycled() && "animate-[hint-flip-in_var(--transition-normal)_ease-out]")));
								return _el$3;
							}
						}), null);
						(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
							...
							get children() {
								...
								(0, solid_js_web.insert)(_el$7, (0, solid_js_web.createComponent)(Kbd, { children: "↑" }), _el$8);
								(0, solid_js_web.insert)(_el$7, (0, solid_js_web.createComponent)(Kbd, { children: "↓" }), _el$8);
								(0, solid_js_web.effect)(() => (0, solid_js_web.className)(_el$7, cn("flex items-center gap-1", require_freeze_updates.HINT_FLIP_IN_ANIMATION)));
								return _el$7;
							}
						}), null);
						(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(solid_js.Show, {
							...
							get children() {
								...
								(0, solid_js_web.insert)(_el$9, (0, solid_js_web.createComponent)(Kbd, { children: "esc" }), _el$0);
								(0, solid_js_web.effect)(() => (0, solid_js_web.className)(_el$9, cn("flex items-center gap-1", require_freeze_updates.HINT_FLIP_IN_ANIMATION)));
								return _el$9;
							}
						}), null);
						(0, solid_js_web.effect)((_p$) => {
							var _v$ = cn(require_freeze_updates.TOOLTIP_BASE_CLASS, "flex items-center gap-1 animate-tooltip-fade-in [animation-fill-mode:backwards]", "bg-white", shakeTooltipPositionClass()), _v$2 = {
								"z-index": String(require_freeze_updates.Z_INDEX_OVERLAY),
								...shakeTooltipPositionStyle()
							};
							_v$ !== _p$.e && (0, solid_js_web.className)(_el$2, _p$.e = _v$);
							_p$.t = (0, solid_js_web.style)(_el$2, _v$2, _p$.t);
							return _p$;
						}, {
							e: void 0,
							t: void 0
					...
					get children() {
						var _el$1 = _tmpl$5$1();
						(0, solid_js_web.effect)((_p$) => {
							var _v$3 = cn(require_freeze_updates.TOOLTIP_BASE_CLASS, "animate-tooltip-fade-in", "bg-white", shakeTooltipPositionClass()), _v$4 = {
								"z-index": String(require_freeze_updates.Z_INDEX_OVERLAY),
								...shakeTooltipPositionStyle()
							};
							_v$3 !== _p$.e && (0, solid_js_web.className)(_el$1, _p$.e = _v$3);
							_p$.t = (0, solid_js_web.style)(_el$1, _v$4, _p$.t);
							return _p$;
						}, {
							e: void 0,
							t: void 0
		...
		(0, solid_js_web.effect)((_p$) => {
			var _v$5 = cn("fixed left-0 top-0 font-sans text-[13px] antialiased select-none", getCursorClass(), getTransitionClass(), isVisible() ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"), _v$6 = String(require_freeze_updates.Z_INDEX_OVERLAY), _v$7 = `translate(${currentPosition().x}px, ${currentPosition().y}px)`, _v$8 = getTransformOrigin();
			_v$5 !== _p$.e && (0, solid_js_web.className)(_el$, _p$.e = _v$5);
			_v$6 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "z-index", _p$.t = _v$6);
			_v$7 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$, "transform", _p$.a = _v$7);
			_v$8 !== _p$.o && (0, solid_js_web.setStyleProperty)(_el$, "transform-origin", _p$.o = _v$8);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
const registerOverlayDismiss = (options) => {
	const handleKeyDown = (event) => {
		...
		if (options.shouldIgnoreInputEvents && require_state.isKeyboardEventTriggeredByInput(event)) return;
	...
	const frameId = require_freeze_updates.nativeRequestAnimationFrame(() => {
	...
	window.addEventListener("keydown", handleKeyDown, { capture: true });
	return () => {
		require_freeze_updates.nativeCancelAnimationFrame(frameId);
		window.removeEventListener("keydown", handleKeyDown, { capture: true });
...
var _tmpl$$5 = /* @__PURE__ */ (0, solid_js_web.template)(`<div class="relative flex flex-col w-[calc(100%+16px)] -mx-2 -my-1.5"><div class="pointer-events-none absolute bg-black/5 opacity-0 transition-[top,left,width,height,opacity] duration-75 ease-out">`), _tmpl$2$2 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-ignore-events data-react-grab-context-menu class="fixed font-sans text-[13px] antialiased filter-[drop-shadow(0px_1px_2px_#51515140)] select-none"style=pointer-events:auto><div><div class="contain-layout shrink-0 flex items-center gap-1 pt-1.5 pb-1 w-fit h-fit px-2">`), _tmpl$3$2 = /* @__PURE__ */ (0, solid_js_web.template)(`<button data-react-grab-ignore-events class="relative z-1 contain-layout flex items-center justify-between w-full px-2 py-1 cursor-pointer text-left border-none bg-transparent disabled:opacity-40 disabled:cursor-default"><span class="text-[13px] leading-4 font-sans font-medium text-black">`), _tmpl$4$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<span class="text-[11px] font-sans text-black/50 ml-4">`);
const ContextMenu = (props) => {
	...
	const tagDisplayResult = (0, solid_js.createMemo)(() => getTagDisplay({
		tagName: props.tagName,
		componentName: props.componentName
	}));
	...
	(0, solid_js.createEffect)(() => {
		if (isVisible()) require_freeze_updates.nativeRequestAnimationFrame(measureContainer);
	});
	const computedPosition = (0, solid_js.createMemo)(() => {
		const bounds = props.selectionBounds;
		const clickPosition = props.position;
		const labelWidth = measuredWidth();
		const labelHeight = measuredHeight();
		if (labelWidth === 0 || labelHeight === 0 || !bounds || !clickPosition) return {
			left: require_freeze_updates.DROPDOWN_OFFSCREEN_POSITION.left,
			top: require_freeze_updates.DROPDOWN_OFFSCREEN_POSITION.top,
			arrowLeft: 0,
	...
	const menuItems = (0, solid_js.createMemo)(() => {
		...
		return pluginActions.map((action) => ({
			...
			enabled: require_state.resolveActionEnabled(action, context),
	...
	(0, solid_js.onMount)(() => {
		...
		const handleKeyDown = (event) => {
			...
			const runActionIfAllowed = (action) => {
				if (!context) return;
				if (!require_state.resolveActionEnabled(action, context)) return;
				event.preventDefault();
				event.stopPropagation();
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			...
			(0, solid_js_web.addEventListener)(_el$, "contextmenu", suppressMenuEvent, true);
			(0, solid_js_web.addEventListener)(_el$, "click", suppressMenuEvent, true);
			(0, solid_js_web.addEventListener)(_el$, "mousedown", suppressMenuEvent, true);
			(0, solid_js_web.addEventListener)(_el$, "pointerdown", suppressMenuEvent, true);
			var _ref$ = containerRef;
			typeof _ref$ === "function" ? (0, solid_js_web.use)(_ref$, _el$) : containerRef = _el$;
			(0, solid_js_web.setStyleProperty)(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			(0, solid_js_web.insert)(_el$, (0, solid_js_web.createComponent)(Arrow, {
				get position() {
			...
			(0, solid_js_web.insert)(_el$3, (0, solid_js_web.createComponent)(TagBadge, {
				get tagName() {
					return tagDisplayResult().tagName;
				},
				get componentName() {
			...
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(BottomSection, { get children() {
				var _el$4 = _tmpl$$5(), _el$5 = _el$4.firstChild;
				(0, solid_js_web.use)(highlightContainerRef, _el$4);
				(0, solid_js_web.use)(highlightRef, _el$5);
				(0, solid_js_web.insert)(_el$4, (0, solid_js_web.createComponent)(solid_js.For, {
					get each() {
						return menuItems();
					},
					children: (item) => (() => {
						...
						(0, solid_js_web.addEventListener)(_el$6, "pointerleave", clearHighlight);
						...
						(0, solid_js_web.insert)(_el$7, () => item.label);
						(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(solid_js.Show, {
							get when() {
								return item.shortcut;
							},
							children: (shortcut) => (() => {
								var _el$8 = _tmpl$4$1();
								(0, solid_js_web.insert)(_el$8, () => formatShortcut(shortcut()));
								return _el$8;
							})()
						}), null);
						(0, solid_js_web.effect)((_p$) => {
							var _v$4 = item.label.toLowerCase(), _v$5 = !item.enabled;
							_v$4 !== _p$.e && (0, solid_js_web.setAttribute)(_el$6, "data-react-grab-menu-item", _p$.e = _v$4);
			...
			(0, solid_js_web.effect)((_p$) => {
				...
				_v$ !== _p$.e && (0, solid_js_web.setStyleProperty)(_el$, "top", _p$.e = _v$);
				_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "left", _p$.t = _v$2);
				_v$3 !== _p$.a && (0, solid_js_web.className)(_el$2, _p$.a = _v$3);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
const createAnchoredDropdown = (containerRef, anchorAccessor) => {
	const [measuredWidth, setMeasuredWidth] = (0, solid_js.createSignal)(0);
	const [measuredHeight, setMeasuredHeight] = (0, solid_js.createSignal)(0);
	const [shouldMount, setShouldMount] = (0, solid_js.createSignal)(false);
	const [isAnimatedIn, setIsAnimatedIn] = (0, solid_js.createSignal)(false);
	const [viewportVersion, setViewportVersion] = (0, solid_js.createSignal)(0);
	const [lastAnchorEdge, setLastAnchorEdge] = (0, solid_js.createSignal)("bottom");
	...
	const clearAnimationHandles = () => {
		...
		if (enterAnimationFrameId !== void 0) {
			require_freeze_updates.nativeCancelAnimationFrame(enterAnimationFrameId);
	...
	(0, solid_js.createEffect)(() => {
		...
		if (anchor) {
			...
			clearTimeout(exitAnimationTimeout);
			setShouldMount(true);
			if (enterAnimationFrameId !== void 0) require_freeze_updates.nativeCancelAnimationFrame(enterAnimationFrameId);
			enterAnimationFrameId = require_freeze_updates.nativeRequestAnimationFrame(() => {
				measure();
		...
		(0, solid_js.onCleanup)(clearAnimationHandles);
	});
	(0, solid_js.createEffect)(() => {
	...
	return {
		...
		isAnimatedIn,
		lastAnchorEdge,
		displayPosition: (0, solid_js.createMemo)((previousPosition) => {
			viewportVersion();
			const position = getAnchoredDropdownPosition({
				...
				anchorGapPx: 8,
				viewportPaddingPx: 8,
				offscreenPosition: require_freeze_updates.DROPDOWN_OFFSCREEN_POSITION
			});
			if (position.left !== require_freeze_updates.DROPDOWN_OFFSCREEN_POSITION.left) return position;
			return previousPosition;
		}, require_freeze_updates.DROPDOWN_OFFSCREEN_POSITION),
		measure,
...
const ToolbarMenu = (props) => {
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			...
			typeof _ref$ === "function" ? (0, solid_js_web.use)(_ref$, _el$) : containerRef = _el$;
			(0, solid_js_web.setStyleProperty)(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			(0, solid_js_web.setStyleProperty)(_el$2, "min-width", `${100}px`);
			(0, solid_js_web.use)(highlightContainerRef, _el$3);
			(0, solid_js_web.use)(highlightRef, _el$4);
			(0, solid_js_web.insert)(_el$3, (0, solid_js_web.createComponent)(solid_js.For, {
				get each() {
				...
				children: (action) => {
					...
					return (() => {
						...
						(0, solid_js_web.addEventListener)(_el$5, "pointerleave", clearHighlight);
						_el$5.addEventListener("pointerenter", (event) => updateHighlight(event.currentTarget));
						_el$5.$$pointerdown = (event) => event.stopPropagation();
						(0, solid_js_web.insert)(_el$6, () => action.label);
						(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
							get when() {
							...
							children: (shortcutKey) => (() => {
								var _el$7 = _tmpl$3$1();
								(0, solid_js_web.insert)(_el$7, () => formatShortcut(shortcutKey()));
								return _el$7;
							})()
						}), null);
						(0, solid_js_web.effect)((_p$) => {
							var _v$8 = action.id, _v$9 = cn("text-[13px] leading-4 font-sans font-medium", isDefault() ? "text-black" : "text-black/60");
							_v$8 !== _p$.e && (0, solid_js_web.setAttribute)(_el$5, "data-react-grab-menu-item", _p$.e = _v$8);
							_v$9 !== _p$.t && (0, solid_js_web.className)(_el$6, _p$.t = _v$9);
							return _p$;
						}, {
							e: void 0,
							t: void 0
			...
			(0, solid_js_web.effect)((_p$) => {
				var _v$ = `${dropdown.displayPosition().top}px`, _v$2 = `${dropdown.displayPosition().left}px`, _v$3 = dropdown.isAnimatedIn() ? "auto" : "none", _v$4 = require_freeze_updates.DROPDOWN_EDGE_TRANSFORM_ORIGIN[dropdown.lastAnchorEdge()], _v$5 = dropdown.isAnimatedIn() ? "1" : "0", _v$6 = dropdown.isAnimatedIn() ? "scale(1)" : "scale(0.95)", _v$7 = cn("contain-layout flex flex-col rounded-[10px] antialiased w-fit h-fit overflow-hidden [font-synthesis:none] [corner-shape:superellipse(1.25)]", "bg-white");
				_v$ !== _p$.e && (0, solid_js_web.setStyleProperty)(_el$, "top", _p$.e = _v$);
				_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "left", _p$.t = _v$2);
				_v$3 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$, "pointer-events", _p$.a = _v$3);
				_v$4 !== _p$.o && (0, solid_js_web.setStyleProperty)(_el$, "transform-origin", _p$.o = _v$4);
				_v$5 !== _p$.i && (0, solid_js_web.setStyleProperty)(_el$, "opacity", _p$.i = _v$5);
				_v$6 !== _p$.n && (0, solid_js_web.setStyleProperty)(_el$, "transform", _p$.n = _v$6);
				_v$7 !== _p$.s && (0, solid_js_web.className)(_el$2, _p$.s = _v$7);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
const CommentsDropdown = (props) => {
	...
	const dropdown = createAnchoredDropdown(() => containerRef, () => props.position);
	const [activeHeaderTooltip, setActiveHeaderTooltip] = (0, solid_js.createSignal)(null);
	const [isCopyAllConfirmed, setIsCopyAllConfirmed] = (0, solid_js.createSignal)(false);
	let copyAllFeedbackTimeout;
	(0, solid_js.createEffect)((0, solid_js.on)(() => dropdown.isAnimatedIn(), (animatedIn) => {
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			...
			typeof _ref$ === "function" ? (0, solid_js_web.use)(_ref$, _el$) : containerRef = _el$;
			(0, solid_js_web.setStyleProperty)(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			(0, solid_js_web.insert)(_el$3, (0, solid_js_web.createComponent)(solid_js.Show, {
				get when() {
				...
				get children() {
					...
					(0, solid_js_web.insert)(_el$7, (0, solid_js_web.createComponent)(IconTrash, { size: 11 }));
					(0, solid_js_web.insert)(_el$6, (0, solid_js_web.createComponent)(Tooltip, {
						get visible() {
					...
					(0, solid_js_web.insert)(_el$9, (0, solid_js_web.createComponent)(solid_js.Show, {
						get when() {
						...
						get children() {
							return (0, solid_js_web.createComponent)(IconCheck, {
								size: 11,
								"class": "text-black"
							});
						}
					}));
					(0, solid_js_web.insert)(_el$8, (0, solid_js_web.createComponent)(Tooltip, {
						get visible() {
			...
			(0, solid_js_web.use)(highlightContainerRef, _el$1);
			(0, solid_js_web.use)(highlightRef, _el$10);
			(0, solid_js_web.insert)(_el$1, (0, solid_js_web.createComponent)(solid_js.For, {
				get each() {
					return props.items;
				},
				children: (item) => (() => {
					var _el$12 = _tmpl$5(), _el$13 = _el$12.firstChild, _el$14 = _el$13.firstChild, _el$16 = _el$13.nextSibling;
					(0, solid_js_web.addEventListener)(_el$12, "blur", clearHighlight);
					...
					(0, solid_js_web.insert)(_el$14, () => getCommentItemDisplayName(item));
					(0, solid_js_web.insert)(_el$13, (0, solid_js_web.createComponent)(solid_js.Show, {
						get when() {
							return item.commentText;
						},
						get children() {
							var _el$15 = _tmpl$4();
							(0, solid_js_web.insert)(_el$15, () => item.commentText);
							return _el$15;
						}
					}), null);
					(0, solid_js_web.insert)(_el$16, () => formatRelativeTime(item.timestamp));
					(0, solid_js_web.effect)((_$p) => (0, solid_js_web.classList)(_el$12, { "opacity-40 hover:opacity-100": Boolean(props.disconnectedItemIds?.has(item.id)) }, _$p));
					return _el$12;
				})()
			}), null);
			(0, solid_js_web.effect)((_p$) => {
				var _v$ = `${dropdown.displayPosition().top}px`, _v$2 = `${dropdown.displayPosition().left}px`, _v$3 = dropdown.isAnimatedIn() ? "auto" : "none", _v$4 = require_freeze_updates.DROPDOWN_EDGE_TRANSFORM_ORIGIN[dropdown.lastAnchorEdge()], _v$5 = dropdown.isAnimatedIn() ? "1" : "0", _v$6 = dropdown.isAnimatedIn() ? "scale(1)" : "scale(0.95)", _v$7 = cn("contain-layout flex flex-col rounded-[10px] antialiased w-fit h-fit overflow-hidden [font-synthesis:none] [corner-shape:superellipse(1.25)]", "bg-white"), _v$8 = `${panelMinWidth()}px`, _v$9 = `${clampedMaxWidth()}px`, _v$0 = `${clampedMaxHeight()}px`;
				_v$ !== _p$.e && (0, solid_js_web.setStyleProperty)(_el$, "top", _p$.e = _v$);
				_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "left", _p$.t = _v$2);
				_v$3 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$, "pointer-events", _p$.a = _v$3);
				_v$4 !== _p$.o && (0, solid_js_web.setStyleProperty)(_el$, "transform-origin", _p$.o = _v$4);
				...
				_v$6 !== _p$.n && (0, solid_js_web.setStyleProperty)(_el$, "transform", _p$.n = _v$6);
				_v$7 !== _p$.s && (0, solid_js_web.className)(_el$2, _p$.s = _v$7);
				_v$8 !== _p$.h && (0, solid_js_web.setStyleProperty)(_el$2, "min-width", _p$.h = _v$8);
				_v$9 !== _p$.r && (0, solid_js_web.setStyleProperty)(_el$2, "max-width", _p$.r = _v$9);
				_v$0 !== _p$.d && (0, solid_js_web.setStyleProperty)(_el$2, "max-height", _p$.d = _v$0);
				return _p$;
			}, {
				e: void 0,
				t: void 0,
...
var _tmpl$$1 = /* @__PURE__ */ (0, solid_js_web.template)(`<div data-react-grab-ignore-events data-react-grab-clear-comments-prompt class="fixed font-sans text-[13px] antialiased filter-[drop-shadow(0px_1px_2px_#51515140)] select-none transition-[opacity,transform] duration-100 ease-out will-change-[opacity,transform]"><div>`);
const ClearCommentsPrompt = (props) => {
	...
	return (0, solid_js_web.createComponent)(solid_js.Show, {
		...
		get children() {
			...
			typeof _ref$ === "function" ? (0, solid_js_web.use)(_ref$, _el$) : containerRef = _el$;
			(0, solid_js_web.setStyleProperty)(_el$, "z-index", `${require_freeze_updates.Z_INDEX_OVERLAY}`);
			(0, solid_js_web.insert)(_el$2, (0, solid_js_web.createComponent)(DiscardPrompt, {
			...
			(0, solid_js_web.effect)((_p$) => {
				var _v$ = `${dropdown.displayPosition().top}px`, _v$2 = `${dropdown.displayPosition().left}px`, _v$3 = dropdown.isAnimatedIn() ? "auto" : "none", _v$4 = require_freeze_updates.DROPDOWN_EDGE_TRANSFORM_ORIGIN[dropdown.lastAnchorEdge()], _v$5 = dropdown.isAnimatedIn() ? "1" : "0", _v$6 = dropdown.isAnimatedIn() ? "scale(1)" : "scale(0.95)", _v$7 = cn("contain-layout flex flex-col rounded-[10px] antialiased w-fit h-fit [font-synthesis:none] [corner-shape:superellipse(1.25)]", "bg-white");
				_v$ !== _p$.e && (0, solid_js_web.setStyleProperty)(_el$, "top", _p$.e = _v$);
				_v$2 !== _p$.t && (0, solid_js_web.setStyleProperty)(_el$, "left", _p$.t = _v$2);
				_v$3 !== _p$.a && (0, solid_js_web.setStyleProperty)(_el$, "pointer-events", _p$.a = _v$3);
				_v$4 !== _p$.o && (0, solid_js_web.setStyleProperty)(_el$, "transform-origin", _p$.o = _v$4);
...
var _tmpl$ = /* @__PURE__ */ (0, solid_js_web.template)(`<div style=position:fixed;top:0;right:0;bottom:0;left:0;pointer-events:none;will-change:opacity;contain:strict;transform:translateZ(0)>`);
const ReactGrabRenderer = (props) => {
	return [
		(0, solid_js_web.createComponent)(OverlayCanvas, {
		...
		(() => {
			var _el$ = _tmpl$();
			(0, solid_js_web.setStyleProperty)(_el$, "z-index", require_freeze_updates.Z_INDEX_OVERLAY_CANVAS);
			(0, solid_js_web.setStyleProperty)(_el$, "transition", `opacity ${100}ms ease-out`);
			(0, solid_js_web.setStyleProperty)(_el$, "box-shadow", `inset 0 0 ${50}px ${require_freeze_updates.FROZEN_GLOW_COLOR}`);
			(0, solid_js_web.effect)((_$p) => (0, solid_js_web.setStyleProperty)(_el$, "opacity", props.isFrozen ? 1 : 0));
			return _el$;
		})(),
		(0, solid_js_web.createComponent)(solid_js.Show, {
			get when() {
				return (0, solid_js_web.memo)(() => !!props.selectionLabelVisible)() && props.selectionBounds;
			},
			get children() {
				return (0, solid_js_web.createComponent)(SelectionLabel, {
					get tagName() {
					...
					onOpen: () => {
						if (props.selectionFilePath) require_freeze_updates.openFile(props.selectionFilePath, props.selectionLineNumber);
					},
		...
		(0, solid_js_web.createComponent)(solid_js.Index, {
			get each() {
				return props.labelInstances ?? [];
			},
			children: (instance) => (0, solid_js_web.createComponent)(SelectionLabel, {
				get tagName() {
				...
				get onShowContextMenu() {
					...
					if (!(currentInstance.status === "copied" || currentInstance.status === "fading") || !require_state.isElementConnected(currentInstance.element)) return;
		...
		(0, solid_js_web.createComponent)(solid_js.Show, {
			...
			get children() {
				return (0, solid_js_web.createComponent)(Toolbar, {
					get isActive() {
						return props.isActive;
					},
					get isContextMenuOpen() {
		...
		(0, solid_js_web.createComponent)(ContextMenu, {
			get position() {
				return props.contextMenuPosition ?? null;
			},
			get selectionBounds() {
		...
		(0, solid_js_web.createComponent)(ToolbarMenu, {
			get position() {
		...
		(0, solid_js_web.createComponent)(ClearCommentsPrompt, {
			get position() {
		...
		(0, solid_js_web.createComponent)(CommentsDropdown, {
			get position() {
...
//#endregion
exports.ReactGrabRenderer = ReactGrabRenderer;