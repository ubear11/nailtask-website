...
const getDefaultStylesForTag = (tagName) => {
	...
	for (const propertyName of require_freeze_updates.RELEVANT_CSS_PROPERTIES) {
...
Object.defineProperty(exports, 'disposeBaselineStyles', {
  enumerable: true,
  get: function () {
    return disposeBaselineStyles;
  }
});
Object.defineProperty(exports, 'extractElementCss', {
  enumerable: true,
  get: function () {
    return extractElementCss;
  }
});