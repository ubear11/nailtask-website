 ...
 */
import { $ as MODIFIER_KEYS, B as ARROW_KEYS, D as Me, E as kt, F as nativeRequestAnimationFrame, H as DEFAULT_ACTION_ID, I as waitUntilNextFrame, L as hideFromThirdParties, M as ve, N as we, O as Oe, P as nativeCancelAnimationFrame, Q as MAX_SESSION_STORAGE_SIZE_BYTES, R as detectCspNonce, S as getNearestComponentName, T as resolveSource, W as DRAG_SELECTION_COVERAGE_THRESHOLD, _ as isRootElement, _t as ZOOM_DETECTION_THRESHOLD, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, d as freezePseudoStates, et as MOUNT_ROOT_RECHECK_DELAY_MS, f as resumePointerEventsFreeze, g as isValidGrabbableElement, gt as VERSION, h as clearVisibilityCache, i as freezeAnimations, j as Z, k as Se, l as getElementAtPosition, m as unfreezePseudoStates, n as logRecoverableError, nt as OFFSCREEN_POSITION, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, pt as TOOLBAR_DEFAULT_POSITION_RATIO, q as FEEDBACK_DURATION_MS, r as freezeAllAnimations, s as openFile, t as freezeUpdates, tt as NEXTJS_REVALIDATION_DELAY_MS, u as getElementsAtPoint, v as checkIsNextProject, vt as Z_INDEX_OVERLAY, w as getStackContext, y as getComponentDisplayName, z as getTagName } from "./freeze-updates-nWyxZZg7.js";
import { a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-MT29CmbX.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-De4jYtv-.js";
...
const getHooksState = (element) => {
	...
	return kt(compositeFiber).filter((hookNode) => hookNode.isStateEditable).slice(0, 8).map((hookNode) => ({
		label: hookNode.name,
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-W_UDDv_g.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
