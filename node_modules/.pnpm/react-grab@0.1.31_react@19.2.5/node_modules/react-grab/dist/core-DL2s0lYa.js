 ...
 */
import { A as Oe, B as detectCspNonce, D as kt, E as Mt, F as we, H as ARROW_KEYS, I as nativeCancelAnimationFrame, K as DRAG_SELECTION_COVERAGE_THRESHOLD, L as nativeRequestAnimationFrame, N as Z, O as zt, P as ve, R as waitUntilNextFrame, S as getNearestComponentName, T as resolveSource, V as getTagName, W as DEFAULT_ACTION_ID, Y as FEEDBACK_DURATION_MS, _ as isRootElement, a as freezeGlobalAnimations, b as getElementContext, bt as Z_INDEX_OVERLAY, c as clearElementPositionCache, d as freezePseudoStates, et as MAX_SESSION_STORAGE_SIZE_BYTES, f as resumePointerEventsFreeze, g as isValidGrabbableElement, h as clearVisibilityCache, ht as TOOLBAR_DEFAULT_POSITION_RATIO, i as freezeAnimations, it as OFFSCREEN_POSITION, j as Se, k as Me, l as getElementAtPosition, m as unfreezePseudoStates, n as logRecoverableError, nt as MOUNT_ROOT_RECHECK_DELAY_MS, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, r as freezeAllAnimations, rt as NEXTJS_REVALIDATION_DELAY_MS, s as openFile, t as freezeUpdates, tt as MODIFIER_KEYS, u as getElementsAtPoint, v as checkIsNextProject, vt as VERSION, w as getStackContext, y as getComponentDisplayName, yt as ZOOM_DETECTION_THRESHOLD, z as hideFromThirdParties } from "./freeze-updates-DBgtn0_k.js";
import { a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-CNuKASp6.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-t_7eJi1y.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		const [resolvedHookRows, setResolvedHookRows] = createSignal(void 0);
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-x68P8Ifx.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
