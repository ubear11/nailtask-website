...
const ElementPropertiesPanel = (props) => (0, solid_js_web.createComponent)(BottomSection, { get children() {
	...
	(0, solid_js_web.insert)(_el$5, (0, solid_js_web.createComponent)(solid_js.Show, {
		get when() {
			return (0, solid_js_web.memo)(() => !!(props.state.source || props.state.timeline && props.state.timeline.totalRenderCount > 0))() && (props.state.reactProps.length > 0 || props.state.hooks.length > 0);
		},
		get children() {
