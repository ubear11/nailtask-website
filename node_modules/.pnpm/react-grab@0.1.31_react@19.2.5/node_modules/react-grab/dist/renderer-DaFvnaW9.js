...
const RenderTimelineBar = (props) => {
	...
	return (() => {
		...
		insert(_el$3, () => props.timeline.totalRenderCount, _el$4);
		insert(_el$3, () => props.timeline.totalRenderCount !== 1 ? "s" : "", _el$7);
...
const ElementPropertiesPanel = (props) => createComponent(BottomSection, { get children() {
	...
	insert(_el$5, createComponent(Show, {
		...
		get children() {
			return createComponent(RenderTimelineBar, { get timeline() {
	...
	insert(_el$5, createComponent(Show, {
		...
		get children() {
			return [createComponent(SectionDivider, {}), (() => {
				var _el$7 = _tmpl$4$4();
				insert(_el$7, () => props.state.className);
				return _el$7;
			})()];
		}
	}), null);
